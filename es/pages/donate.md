...
Are you an organization, company, or individual who believes in our vision and wants to make an impact on our efforts? [Become a Qubes Partner](/es/partners/) by giving a significant financial contribution.
...
There are also [many more ways to contribute](/es/doc/contributing/)!

## FAQs on donating
<a id="faqs-on-donating"></a>

Frequently asked questions about Qubes donations.
Join the conversation on our [mailing lists and forum](/es/support/).
...
[Here is what security and privacy experts say about the project.](/es/experts/)
...
The donation address can be verified via the [Qubes Security Pack](/es/security/pack/), specifically in the [fund directory](https://github.com/QubesOS/qubes-secpack/tree/master/fund).
We provide [detailed instructions for verifying the digital signatures](/es/security/pack/#how-to-obtain-verify-and-read).
...
Visit our [introduction page to Qubes](/es/intro/) or watch a [video overview of the system](/es/video-tours/) to learn more.
