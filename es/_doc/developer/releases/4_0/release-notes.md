...
* New [backup format](/es/doc/backup-emergency-restore-v4/) using scrypt key-derivation function
...
* [More flexible firewall interface](/es/doc/vm-interface/) for ease unikernel integration
...
* More flexible Qubes RPC policy - [related ticket](https://github.com/QubesOS/qubes-issues/issues/865), [documentation](/es/doc/qrexec/#specifying-vms-tags-types-targets-etc)
...
[qubes backup and restore tools](/es/doc/backup-restore/) for migrating of all of the user VMs.
We also provide [detailed instruction](/es/doc/upgrade-to-r4.0/) for this procedure.