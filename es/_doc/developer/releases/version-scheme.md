...
lang: es
layout: doc
permalink: /es/doc/version-scheme/
redirect_from:
- /es/doc/VersionScheme/
- /es/wiki/VersionScheme/
ref: 151
...
Lists, and Forum](/es/support/) for places to ask questions about stable releases. No major
