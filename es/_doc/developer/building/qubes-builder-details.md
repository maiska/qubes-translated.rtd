...
lang: es
layout: doc
permalink: /es/doc/qubes-builder-details/
redirect_from:
- /es/doc/QubesBuilderDetails/
- /es/wiki/QubesBuilderDetails/
ref: 65
...
* For a list of custom TemplateVMs available in QubesBuilder look at [Supported Versions page](/es/doc/supported-versions/).