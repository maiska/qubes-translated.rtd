...
lang: es
layout: doc
permalink: /es/doc/qrexec2/
redirect_from:
- /es/wiki/Qrexec2Implementation/
- /es/doc/qrexec2-implementation/
- /es/doc/Qrexec2Implementation/
ref: 38
title: Qrexec2
---
...
(*This page is about qrexec v2. For qrexec v3, see [here](/es/doc/qrexec3/).*)
...
<a id="qubes-rpc-administration"></a>
...
<a id="requesting-vm-vm-and-vm-dom0-services-execution"></a>
...
<a id="revoking-yes-to-all-authorization"></a>
...
<a id="qubes-rpc-hello-world-service"></a>
...
qrexec v3, see [here](/es/doc/qrexec-internals/). Note that the user
...
<a id="linux-vms-implementation"></a>
...
<a id="windows-vms-implementation"></a>
...
<a id="all-the-pieces-together-at-work"></a>

**Note:** This section is not needed to use qrexec for writing Qubes
apps. Also note the [qrexec framework implemention in Qubes R3](/es/doc/qrexec3/)
