...
[qubes](/es/doc/glossary/#qube), which are implemented as lightweight [virtual
machines (VMs)](/es/doc/glossary/#vm). For example, the user can have “personal,”
