...
lang: es
layout: doc
permalink: /es/doc/code-signing/
ref: 51
title: Code Signing
---

All contributions to the Qubes OS [source code](/es/doc/source-code/) must be cryptographically signed by the author's PGP key.

## Generating a Key
<a id="generating-a-key"></a>
...
<a id="github-signature-verification-optional"></a>
...
<a id="using-pgp-with-email"></a>

If you're submitting a patch by emailing the [developer mailing list](/es/support/#qubes-devel), simply sign your email with your PGP key.
