...
lang: es
layout: doc
permalink: /es/doc/package-contributions/
ref: 29
title: Package Contributions
---

_This page is for developers who wish to contribute packages.
If you want to install contributed packages, please see [installing contributed packages](/es/doc/installing-contributed-packages/)._
...
* Be published under an open-source license (read about the [Qubes OS License](/es/doc/license/)).
* Follow our [coding guidelines](/es/doc/coding-style/).
...
Before you start putting serious work into a package, we recommend that you discuss your idea with the Qubes developers and the broader community on the [qubes-devel mailing list](/es/support/#qubes-devel).
...
3. If you haven't already, [sign your code](/es/doc/code-signing/).
...
If you would like to update an already-contributed package (specifically, a fork owned by [QubesOS-contrib](https://github.com/QubesOS-contrib)), please submit a [signed](/es/doc/code-signing/), fast-forwardable pull request to that repo with your changes.
Please note that your pull request **must** be both [signed](/es/doc/code-signing/) and fast-forwardable, or else it will be closed without further review.
...
3. The PM reviews the pull request.
   If the the pull request passes the PM's review, the PM adds a [signed](/es/doc/code-signing/) *comment* on the pull request stating that it has passed review.
   (In cases in which S = PM, the PM can simply add a [signed](/es/doc/code-signing/) *tag* to the HEAD commit prior to submitting the pull request.)
...
4. The QCR reviews the pull request.
   If the pull request passes the QCR's review, the QCR pushes a [signed](/es/doc/code-signing/) tag to the HEAD commit stating that it has passed review and fast-forward merges the pull request.
