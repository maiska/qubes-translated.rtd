...
For example, Qubes OS may use a popular Linux distribution for an official [TemplateVM](/es/doc/templates/).
...
[QSBs]: /es/security/bulletins/
[Canaries]: /es/security/canaries/
[News]: /es/news/
[md]: https://daringfireball.net/projects/markdown/
[git-commit]: /es/doc/coding-style/#commit-message-guidelines
...
[external documentation]: /es/doc/#external-documentation
