...
lang: es
layout: doc
permalink: /es/doc/doc-guidelines/
redirect_from:
- /es/doc/DocStyle/
- /es/wiki/DocStyle/
ref: 30
...
*Also see: [Should I trust this website?](/es/faq/#should-i-trust-this-website)*
...
documentation](/es/doc/#external-documentation) (see
...
send it to the appropriate [mailing list](/es/support/). If you see that something
...
guidelines](/es/doc/issue-tracking/). (If you report an issue with the
...
* We don't want you to spend time and effort on a contribution that we can't
  ...
  issue](/es/doc/issue-tracking/) for it first so that we can make sure we're on
...
table of contents)](/es/doc/) --- for example, if you're adding a new page,
...
The source file for the [documentation index (a.k.a. table of contents)](/es/doc/)
lives here:
...
[TemplateVM](/es/doc/templates/). However, it would not make sense for a
...
* Familiarize yourself with the terms defined in the
  [glossary](/es/doc/glossary/). Use these terms consistently and accurately
...
* In order to enable offline browsing and automatic onion redirection, always
  ...
  exceptions:
  * The signed plain text portions of [QSBs](/es/security/qsb/) and
    [Canaries](/es/security/canary/)
...
coding style guidelines](/es/doc/coding-style/#commit-message-guidelines).