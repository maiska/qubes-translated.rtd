...
<a id="information-for-students"></a>

Thank you for your interest in participating in the [Google Summer of Code program](https://summerofcode.withgoogle.com/organizations/4675790572093440/) with the [Qubes OS team](/es/team/). You can read more about the Google Summer of Code program at the [official website](https://summerofcode.withgoogle.com/) and the [official FAQ](https://developers.google.com/open-source/gsoc/faq).
...
You don't have to be a proven developer -- in fact, this whole program is meant to facilitate joining Qubes and other free and open source communities. The Qubes community maintains information about [contributing to Qubes development](/es/doc/contributing/#contributing-code) and [how to send patches](/es/doc/source-code/#how-to-send-patches). In order to contribute code to the Qubes project, you must be able to [sign your code](/es/doc/code-signing/).

You should start learning the components that you plan on working on before the start date. Qubes developers are available on the [mailing lists](/es/support/#qubes-devel) for help. The GSoC timeline reserves a lot of time for bonding with the project -- use that time wisely. Good communication is key, you should plan to communicate with your team daily and formally report progress and plans weekly. Students who neglect active communication will be failed.

### Overview of Steps
<a id="overview-of-steps"></a>

- Join the [qubes-devel list](/es/support/#qubes-devel) and introduce yourself, and meet your fellow developers
...
These project ideas were contributed by our developers and may be incomplete. If you are interested in submitting a proposal based on these ideas, you should contact the [qubes-devel mailing list](/es/support/#qubes-devel) and associated GitHub issue to learn more about the idea.
...
<a id="qubes-as-a-vagrant-provider"></a>
...
**Mentor**: [Wojtek Porczyk](/es/team/), [Marek Marczykowski-Górecki](/es/team/)

### Mechanism for maintaining in-VM configuration
<a id="mechanism-for-maintaining-in-vm-configuration"></a>
...
**Mentor**: [Frédéric Pierret](/es/team/)

### Wayland support in GUI agent and/or GUI daemon
<a id="wayland-support-in-gui-agent-andor-gui-daemon"></a>
...
- [Low level GUI documentation](/es/doc/gui/)
...
**Mentor**: [Marek Marczykowski-Górecki](/es/team/).

### Qubes Live USB
<a id="qubes-live-usb"></a>
...
**Mentor**: [Thomas Leonard](mailto:talex5@gmail.com), [Marek Marczykowski-Górecki](/es/team/)
-->
...
<a id="whonix-ipv6-and-nftables-support"></a>
...
**Mentor**: [Patrick Schleizer](/es/team/)


### GUI agent for Windows 8/10
<a id="gui-agent-for-windows-810"></a>
...
**Mentor**: [Rafał Wojdyła](/es/team/)

### Unattended Windows installation
<a id="unattended-windows-installation"></a>
...
**Mentor**: [Rafał Wojdyła](/es/team/), [Marek Marczykowski-Górecki](/es/team/)

### GNOME support in dom0 / GUI VM
<a id="gnome-support-in-dom0--gui-vm"></a>
...
**Mentor**: [Frédéric Pierret](/es/team/), [Marek Marczykowski-Górecki](/es/team/)

### Generalize the Qubes PDF Converter to other types of files
<a id="generalize-the-qubes-pdf-converter-to-other-types-of-files"></a>
...
<a id="progress-towards-reproducible-builds"></a>
...
<a id="android-development-in-qubes"></a>
...
**Mentor**: Inquire on [qubes-devel](/es/support/#qubes-devel).

### Admin API Fuzzer
<a id="admin-api-fuzzer"></a>

**Project**: Develop a [Fuzzer](https://en.wikipedia.org/wiki/Fuzzing) for the
[Qubes OS Admin API](/es/doc/admin-api/).

**Brief explanation**: The [Qubes OS Admin API](/es/doc/admin-api/)
...
<a id="reduce-logging-of-disposable-vms"></a>
...
<a id="template-manager-new-template-distribution-mechanism"></a>
