...
lang: es
layout: doc
permalink: /es/doc/issue-tracking/
redirect_from:
- /es/bug-report/
- /es/bug-reports/
- /es/bug/
...
<a id="how-to-open-a-new-issue"></a>
...
OS](/es/security/#reporting-security-issues-in-qubes-os).

### I need help, have a question, or want to discuss something
<a id="i-need-help-have-a-question-or-want-to-discuss-something"></a>

Please see [Help, Support, Mailing Lists, and Forum](/es/support/).

### I see something that should be changed in the documentation
<a id="i-see-something-that-should-be-changed-in-the-documentation"></a>

We encourage you to submit the change yourself! Please see the [Documentation
Guidelines](/es/doc/doc-guidelines/) for instructions on how to do so. If it's
something you can't do yourself, please proceed to the next section.

### I still want to open an issue
<a id="i-still-want-to-open-an-issue"></a>
...
2. [Search through the existing issues](#search-tips), both open and closed, to
   ...
   duplicate.](/es/doc/issue-tracking/#new-issues-should-not-be-duplicates-of-existing-issues)
...
closed](/es/doc/issue-tracking/#how-issues-get-closed) for details about when,
why, and how this occurs.

## Labels, Milestones, and Projects
<a id="labels-milestones-and-projects"></a>
...
<a id="the-issue-tracker-is-not-a-discussion-forum"></a>
...
lists (see [Help, Support, Mailing Lists, and Forum](/es/support/)). You can
...
Support, Mailing Lists, and Forum](/es/support/) for appropriate place to ask
...
Forum](/es/support/) for the appropriate place to post it. If your issue would be
...
information out of dom0](/es/doc/how-to-copy-from-dom0/)). If your issue is
...
List (HCL) report](/es/doc/hcl/#generating-and-submitting-new-reports), then
...
[testing](/es/doc/testing/) repository, please reference the appropriate issue in
...
appropriate [testing](/es/doc/testing/) repository, then to the appropriate stable
repository. If you so choose, you can test the fix while it's in the
[testing](/es/doc/testing/) repository, or you can wait for it to land in the
...
- [Testing New Releases and Updates](/es/doc/testing/)
