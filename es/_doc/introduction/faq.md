...
<a id="my-qubes-lost-internet-access-after-a-templatevm-update-what-should-i-do"></a>

See [Update Troubleshooting](/es/doc/update-troubleshooting/#lost-internet-access-after-a-templatevm-update).
...
<a id="my-dom0-andor-templatevm-update-stalls-when-attempting-to-update-via-the-gui-tool-what-should-i-do"></a>
...
<a id="i-created-a-usbvm-and-assigned-usb-controllers-to-it-now-the-usbvm-wont-boot"></a>

This is probably because one of the controllers does not support reset.
See the [USB Troubleshooting guide](/es/doc/usb-troubleshooting/#usbvm-does-not-boot-after-creating-and-assigning-usb-controllers-to-it).
...
<a id="how-do-i-install-flash-in-a-debian-qube"></a>
...
See [Block (Storage) Devices][storage](/es/doc/block-devices/) for more information.
...
<a id="when-i-try-to-install-a-templatevm-it-says-no-match-is-found"></a>

See [VM Troubleshooting](/es/doc/vm-troubleshooting/#no-match-found-when-trying-to-install-a-templatevm).
...
[4.x System Requirements]: /es/doc/system-requirements/#qubes-release-4x
...
[assign_devices]: /es/doc/assigning-devices/
...
[custom_config]: /es/doc/custom-install/
[Debian is not certified]: https://www.gnu.org/distros/common-distros.en.html
[disposable]: /es/doc/disposablevm/
[disposable qube]: /es/doc/dispvm/
...
[Enable RPMFusion]: /es/doc/software-update-domu/#rpmfusion-for-fedora-templatevms
[file]: /doc/copying-files
[firewalls]: /doc/firewall
[GitHub Pages]: https://pages.github.com/
[glossary]: /es/doc/glossary/
...
[Markdown]: /es/doc/doc-guidelines/#markdown-conventions
[network]: /es/doc/networking/
...
[storage]: /es/doc/block-devices/
[system requirements]: /es/doc/system-requirements/
...
[this page]: /es/doc/vm-sudo/
[Tor]: https://www.torproject.org/
[USB]: /doc/usb-devices
[verify the PGP signatures on the commits and/or tags]: /es/security/verifying-signatures/#how-to-verify-qubes-repos
[version]: /es/doc/version-scheme/#check-installed-version
[website repo]: https://github.com/QubesOS/qubesos.github.io
[why?]: #why-do-you-use-github
[Xen]: https://www.xenproject.org/
[XSA Tracker]: /es/security/xsa/
[reporting-bugs]: /es/doc/reporting-bugs/