...
Issues in Qubes OS](/es/security/#reporting-security-issues-in-qubes-os).
...
1. Check the [documentation](/es/doc/). There may already be a page about it.
   Specifically, check out the [How-to Guides](/es/doc/#how-to-guides) and
   [Troubleshooting](/es/doc/#troubleshooting) sections.

2. Search the [FAQ](/es/faq/). Your question might already be answered.

3. Try [searching the issue tracker](/es/doc/issue-tracking/#search-tips). There
...
already reported it first)! Please see [Issue Tracking](/es/doc/issue-tracking/)
for details.
...
Tracking](/es/doc/issue-tracking/) for details.
...
Thank you for asking! Please see [How to Contribute](/es/doc/contributing/) for
...
our [Code of Conduct](/es/code-of-conduct/). Be friendly and open, but do not
...
the [Qubes team](/es/team/) anywhere on the Internet. Please don't assume that
...
message](/es/security/verifying-signatures/). (But bear in mind that anyone can
...
[verification](/es/security/verifying-signatures/) is what counts.) All official
[news](/news/) can be authenticated by [verifying the
signatures](/es/security/verifying-signatures/) on the relevant tags or commits in
...
themselves knowledgeable through their [contributions](/es/doc/contributing/) to
...
contributions](/es/doc/code-signing/).

For example, you might find it easier to trust advice from someone who has a
proven track record of [contributing software
packages](/es/doc/package-contributions/) or [contributing to the
documentation](/es/doc/doc-guidelines/). It's unlikely that individuals who have
...
position to [verify](/es/security/verifying-signatures/) that these came from the
same keyholder.
...
report](/es/doc/hcl/#generating-and-submitting-new-reports), then linking to it in
...
integration of Qubes with [Whonix](/es/doc/whonix/), we understand better than
...
of Conduct](/es/code-of-conduct/) for more information.
...
that you submit it to our [issue tracker](/es/doc/issue-tracking/) so that it
doesn't get overlooked. (However, please remember that [the issue tracker is
not a discussion
forum](/es/doc/issue-tracking/#the-issue-tracker-is-not-a-discussion-forum).)
...
change](/es/doc/doc-guidelines/).

### Moderation
<a id="moderation"></a>

The moderation team aims to enforce our [Code of Conduct](/es/code-of-conduct/).
...
infrastructure](/es/faq/#what-does-it-mean-to-distrust-the-infrastructure). This
is why, for example, we encourage discussants to use [Split
GPG](/es/doc/split-gpg/) to sign all of their messages to the lists, but we do not
...
[Qubes Security Bulletins (QSBs)](/es/security/qsb/), new stable releases,
...
* The [Installation Guide](/es/doc/installation-guide/), [System
  Requirements](/es/doc/system-requirements/), and [HCL](/es/doc/hcl/) (for problems
  related to installing Qubes OS)
* The [User FAQ](/es/faq/#users)
* The [documentation](/es/doc/) (for questions about how to use Qubes OS)
