...
lang: es
layout: doc
permalink: /es/security/pack/
redirect_from:
- /es/doc/SecurityPack/
- /es/doc/qsp/
- /es/doc/sec-pack/
- /es/doc/secpack/
- /es/doc/security-pack/
- /es/qsp/
- /es/sec-pack/
- /es/secpack/
- /es/security-pack/
- /es/wiki/SecurityPack/
ref: 213
...
* [Signed Qubes ISO digests](/es/security/verifying-signatures/#how-to-verify-qubes-iso-digests)
...
<a id="how-to-obtain-verify-and-read"></a>
...
3. Verify and trust the Qubes Master Signing Key.
   ...
   **Important!**
   ...
   key verification [here](/es/security/verifying-signatures/).
