...
lang: es
layout: doc
permalink: /es/doc/upgrade-to-r3.1/
redirect_from:
- /es/doc/UpgradeToR3.1/
- /es/doc/UpgradeToR3.1rc1/
ref: 155
...
found [here](/es/doc/software-update-vm/). The steps described in this
...
[User FAQ](/es/faq/#i-created-a-usb-vm-and-assigned-usb-controllers-to-it-now-the-usb-vm-wont-boot)
for details.
