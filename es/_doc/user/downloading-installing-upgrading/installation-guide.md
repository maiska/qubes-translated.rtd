...
Qubes OS has very specific [system requirements](/es/doc/system-requirements/). To
ensure compatibility, we strongly recommend using [Qubes-certified
hardware](/es/doc/certified-hardware/). Other hardware may require you to perform
...
Start by [downloading](/es/downloads/) a Qubes ISO.
...
<div class="alert alert-danger" role="alert">
  ...
  href="/es/security/verifying-signatures/">verify its authenticity</a> before
  continuing.
</div>
...
[downloads](/es/downloads/) page by hovering over the download button.

<div class="alert alert-warning" role="alert">
  <i class="fa fa-exclamation-circle"></i>
  <b>Note:</b> There are important <a href="/es/doc/install-security/">security
...
please see [custom installation](/es/doc/custom-install/). Otherwise, follow the
instructions below.
...
* **Debian:** Select this option if you would like to use
  [Debian](/es/doc/templates/debian/) qubes in addition to the default Fedora
  qubes.
* **Whonix:** Select this option if you would like to use
  [Whonix](/es/doc/whonix/) qubes. Whonix allows you to use
...
these and other [templates](/es/doc/templates/) later. If you're short on disk
...
[Advanced Topics](/es/doc/#advanced-topics)).
...
Next, [update](/es/doc/how-to-update/) your installation to ensure you have
...
(QSBs)](/es/security/qsb/) as part of the [Qubes Security Pack
(qubes-secpack)](/es/security/pack/). It is important to make sure that you
...
[qubes-announce](/es/support/#qubes-announce) mailing list.

In addition to QSBs, the Qubes OS Project also publishes
[Canaries](/es/security/canary/), XSA summaries, template releases and
...
[qubes-announce](/es/support/#qubes-announce) in order to keep the volume on that
...
of our other [venues](/es/support/), where these news items are also announced.
...
system](/es/doc/how-to-back-up-restore-and-migrate/) allows you to do this
securely and easily.
...
report](/es/doc/hcl/#generating-and-submitting-new-reports).

### Get Started
<a id="get-started"></a>

Find out [How to Get Started](/es/doc/how-to-get-started/) with Qubes, check out
the other [How-to Guides](/es/doc/#how-to-guides), and learn about
[Templates](/es/doc/#templates).

## Getting help
<a id="getting-help"></a>

* We work very hard to make the [documentation](/es/doc/) accurate, comprehensive
  ...
  [improving](/es/doc/doc-guidelines/) it!)
...
* If you don't find your answer in the documentation, please see [Help,
  Support, Mailing Lists, and Forum](/es/support/) for places to ask.
...
* Please do **not** email individual members of the Qubes team with questions
  ...
  Mailing Lists, and Forum](/es/support/) for appropriate places to ask questions.