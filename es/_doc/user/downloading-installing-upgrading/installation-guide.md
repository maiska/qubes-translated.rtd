...
lang: es
layout: doc
permalink: /es/doc/installation-guide/
redirect_from:
- /es/doc/live-usb/
- /es/doc/InstallationGuideR2rc2/
- /es/doc/InstallationGuideR2B3/
- /es/wiki/InstallationGuide/
- /es/doc/InstallationGuideR2B2/
- /es/doc/InstallationGuideR2rc1/
- /es/doc/InstallationGuide/
- /es/doc/InstallationGuideR2B1/
- /es/doc/InstallationGuideR1/
- /es/doc/InstallationGuideR3.0rc2/
- /es/doc/InstallationGuideR3.0rc1/
ref: 153
...
<div class="alert alert-danger" role="alert">
  ...
  See <a href="/es/doc/install-security/">installation security</a> for more information.
</div>
...
<a id="copying-the-iso-onto-the-installation-medium"></a>
...
<div class="alert alert-danger" role="alert">
  ...
  Regardless of how you acquire your Qubes ISO, <a href="/es/security/verifying-signatures/">verify its authenticity</a> before continuing.
</div>
...
<div class="alert alert-warning" role="alert">
  <i class="fa fa-exclamation-circle"></i>
  <b>Note:</b> There are important <a href="/es/doc/install-security/">security considerations</a> to keep in mind when choosing an installation medium.
</div>
...
<a id="getting-to-the-boot-screen"></a>
...
<a id="the-installer-home-screen"></a>
...
<a id="installation-destination"></a>
...
<a id="create-your-user-account"></a>
...
The Qubes OS Project occasionally issues [Qubes Security Bulletins (QSBs)](/es/security/bulletins/) as part of the [Qubes Security Pack (qubes-secpack)](/es/security/pack/).
...
For this reason, we strongly recommend that every Qubes user subscribe to the [qubes-announce](/es/support/#qubes-announce) mailing list.

In addition to QSBs, the Qubes OS Project also publishes [Canaries](/es/security/canaries/), XSA summaries, TemplateVM releases and end-of-life notices, and other items of interest to Qubes users.
Since these are not essential for all Qubes users to read, they are not sent to [qubes-announce](/es/support/#qubes-announce) in order to keep the volume on that list low.
However, we expect that most users, especially novice users, will find them helpful.
If you are interested in these additional items, we encourage you to subscribe to the [Qubes News RSS feed](/feed.xml) or join one of our other [venues](/es/support/), where these news items are also announced.

For more information about Qubes OS Project security, please see the [security center](/es/security/).
...
[live USB]: /es/doc/live-usb/
[downloads]: /es/downloads/
[verifying signatures]: /es/security/verifying-signatures/
[security considerations]: /es/doc/install-security/
[Custom Installation]: /es/doc/custom-install/
[Upgrade Guides]: /es/doc/upgrade/
[Rufus]: https://rufus.akeo.ie/
[documentation]: /es/doc/
[improving]: /es/doc/doc-guidelines/
[Help, Support, Mailing Lists, and Forum]: /es/support/
[update]: /es/doc/updating-qubes-os/
[Qubes backup system]: /es/doc/backup-restore/
[Common Tasks]: /es/doc/#common-tasks
[Managing Operating Systems within Qubes]: /es/doc/#managing-operating-systems-within-qubes
[installation security]: /es/doc/install-security/
...
[advanced configuration]: /es/doc/#advanced-configuration
[hcl-howto]: /es/doc/hcl/#generating-and-submitting-new-reports
[Get Started]: /es/getting-started/