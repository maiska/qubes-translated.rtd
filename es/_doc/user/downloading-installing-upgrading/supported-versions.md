...
or minor release (see [Version Scheme](/es/doc/version-scheme/)). The current
release and past major releases are always available on the
[Downloads](/es/downloads/) page, while all ISOs, including past minor releases,
are available from our [download mirrors](/es/downloads/#mirrors).
...
[security-critical](/es/doc/security-critical-code/), and we provide updates for
...
The following table shows select [template](/es/doc/templates/) versions that are
currently supported. Currently, only [Fedora](/es/doc/templates/fedora/) and
[Debian](/es/doc/templates/debian/) templates are officially supported by the
Qubes OS Project. [Whonix](/es/doc/whonix/) templates are supported by our
...
a mailing list similar to [qubes-announce](/es/support/#qubes-announce), which
...
[Whonix](/es/doc/whonix/) templates are supported by our partner, the [Whonix
