...
lang: es
layout: doc
permalink: /es/doc/disposablevm-customization/
redirect_from:
...
<a id="disposablevm-customization"></a>

## Introduction
<a id="introduction"></a>

A [DisposableVM](/doc/disposablevm) can be based on any [TemplateBasedVM](/es/doc/glossary/#templatebasedvm).
You can also choose to use different [DisposableVM Templates](/es/doc/glossary/#disposablevm-template) for different DisposableVMs.
...
<a id="creating-a-new-disposablevm-template"></a>
...
If you wish to use a [Minimal TemplateVM](/es/doc/templates/minimal/) as a DisposableVM Template, please see the [Minimal TemplateVM](/es/doc/templates/minimal/) page.

## Customization of DisposableVM
<a id="customization-of-disposablevm"></a>
...
<a id="using-static-disposablevms-for-sys-"></a>
...
**Note** You can use `qvm-pci` to [determine](/es/doc/pci-devices/#qvm-pci-usage) the `<BDF>`.
Also, you will often need to include the `-o no-strict-reset=True` [option](/es/doc/pci-devices/#no-strict-reset) with USB controllers.
...
<a id="adding-programs-to-disposablevm-application-menu"></a>
...
<a id="create-custom-sys-net-sys-firewall-and-sys-usb-disposablevms"></a>
...
<a id="create-and-configure-the-disposablevm-template-on-which-the-disposablevm-will-be-based"></a>
...
<a id="create-the-sys-net-disposablevm"></a>
...
6. Attach the network PCI device(s) to `disp-sys-net` (finding and assigning PCI devices can be found [here](/es/doc/pci-devices/):
...
<a id="create-the-sys-firewall-disposablevm"></a>
...
<a id="create-the-sys-usb-disposablevm"></a>
...
5. Attach the USB controller to the `disp-sys-usb`:
   >_**Note:**_ Most of the commonly used USB controllers (all Intel integrated controllers) require the `-o no-strict-reset=True` option to be set. Instructions detailing how this option is set can be found [here](/es/doc/pci-devices/#no-strict-reset).
...
<a id="starting-the-disposablevms"></a>
