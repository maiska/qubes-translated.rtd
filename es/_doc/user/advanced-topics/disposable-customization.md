...
lang: es
layout: doc
permalink: /es/doc/disposable-customization/
redirect_from:
- /es/doc/DispVMCustomization/
- /es/doc/UserDoc/DispVMCustomization/
- /es/doc/disposablevm-customization/
- /es/doc/dispvm-customization/
- /es/wiki/UserDoc/DispVMCustomization/
ref: 174
...
A [disposable](/es/doc/disposable/) can be based on any [app qube](/es/doc/glossary/#app-qube).
You can also choose to use different [disposable templates](/es/doc/glossary/#disposable-template) for different disposables.
...
<a id="creating-a-new-disposable-template"></a>
...
The above default is used whenever a qube request starting a new disposable and do not specify which one (for example `qvm-open-in-dvm` tool). This can be also set in qube settings and will affect service calls from that qube. See [qrexec documentation](/es/doc/qrexec/#specifying-vms-tags-types-targets-etc) for details.

If you wish to use a [Minimal Template](/es/doc/templates/minimal/) as a disposable template, please see the [Minimal Template](/es/doc/templates/minimal/) page.

## Customization of disposable
<a id="customization-of-disposable"></a>
...
<a id="using-named-disposables-for-sys-"></a>

You can use a [named disposable](/es/doc/glossary/#named-disposable) for `sys-*` as long as it is stateless.
...
**Note** You can use `qvm-pci` to [determine](/es/doc/how-to-use-pci-devices/#qvm-pci-usage) the `<BDF>`.
Also, you will often need to include the `-o no-strict-reset=True` [option](/es/doc/how-to-use-pci-devices/#no-strict-reset) with USB controllers.
...
<a id="adding-programs-to-disposable-application-menu"></a>
...
<a id="create-custom-sys-net-sys-firewall-and-sys-usb-disposables"></a>
...
<a id="create-and-configure-the-disposable-template-on-which-the-disposable-will-be-based"></a>
...
<a id="create-the-sys-net-disposable"></a>
...
2. Set `disp-sys-net` virtualization mode to [hvm](/es/doc/hvm/):
...
6. Attach the network PCI device(s) to `disp-sys-net` (finding and assigning PCI devices can be found [here](/es/doc/how-to-use-pci-devices/):
...
<a id="create-the-sys-firewall-disposable"></a>
...
<a id="create-the-sys-usb-disposable"></a>
...
5. Attach the USB controller to the `disp-sys-usb`:
   >_**Note:**_ Most of the commonly used USB controllers (all Intel integrated controllers) require the `-o no-strict-reset=True` option to be set. Instructions detailing how this option is set can be found [here](/es/doc/how-to-use-pci-devices/#no-strict-reset).
...
8. Users should now follow instructions on [How to hide USB controllers from dom0](/es/doc/usb-qubes/#how-to-hide-all-usb-controllers-from-dom0).
...
<a id="starting-the-disposables"></a>
...
If the `disp-sys-usb` does not start, it could be due to a PCI passthrough problem. For more details on this issue along with possible solutions, users can look [here](/es/doc/pci-troubleshooting/#pci-passthrough-issues).

## Deleting disposables
<a id="deleting-disposables"></a>
