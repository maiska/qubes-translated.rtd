...
<a id="increasing-the-size-of-disk-images"></a>
...
In case of template-based qubes, the private storage (the /home directory and user files) can be changed in the qube's own settings, but the system root image is [inherited from the template](/es/doc/how-to-get-started/), and so it must be changed in the template settings.
...
### Increasing the size of Disk Images
<a id="increasing-the-size-of-disk-images-1"></a>
...
<a id="decreasing-the-size-of-disk-images"></a>
