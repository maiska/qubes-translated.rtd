...
lang: es
layout: doc
permalink: /es/doc/how-to-install-software-in-dom0/
redirect_from:
- /es/doc/SoftwareUpdateDom0/
- /es/doc/software-update-dom0/
...
There are three Qubes dom0 [testing](/es/doc/testing/) repositories:
...
packages](/es/doc/installing-contributed-packages/).
...
- `kernel`: an older LTS kernel that has passed Qubes [testing](/es/doc/testing/)
  (the default dom0 kernel)
- `kernel-latest`: the latest release from kernel.org that has passed Qubes
  [testing](/es/doc/testing/) (useful for [troubleshooting newer
  hardware](/es/doc/newer-hardware-troubleshooting/))
...
[Managing VM kernel](/es/doc/managing-vm-kernels/) for more information.
