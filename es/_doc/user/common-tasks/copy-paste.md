...
If you wish to copy more complex data, such as rich text or images, see [copying and moving files between qubes](/es/doc/copying-files/).
For dom0, see [copying from (and to) dom0](/es/doc/copy-from-dom0/).*
