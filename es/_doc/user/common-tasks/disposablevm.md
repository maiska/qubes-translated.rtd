...
Similarly to how AppVMs are based on their underlying [TemplateVM](/es/doc/glossary/#templatevm), DisposableVMs are based on their underlying [DisposableVM Template](/es/doc/glossary/#disposablevm-template).
...
Full instructions can be found [here](/es/doc/disposablevm-customization/).

[DisposableVM Template]: /es/doc/glossary/#disposablevm-template
[qrexec]: /es/doc/qrexec/#qubes-rpc-administration