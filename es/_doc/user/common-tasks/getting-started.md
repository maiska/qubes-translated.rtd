...
lang: es
layout: default
permalink: /es/doc/getting-started/
redirect_from:
...
--------------------------
<a id="gui-and-command-line-tools"></a>
...
[downloading]: /es/downloads/
[installing]: /es/doc/installation-guide/
[virtual machines (VMs)]: /es/doc/glossary/#vm
[qubes]: /es/doc/glossary/#qube
[security domain]: /es/doc/glossary/#domain
[template]: /es/doc/glossary/#templatevm
...
[copy-files]: /es/doc/copying-files/
[copy-paste]: /es/doc/copy-paste/
[Copying from (and to) dom0]: /es/doc/copy-from-dom0/
[Fullscreen Mode]: /es/doc/full-screen-mode/
[DisposableVMs]: /es/doc/disposablevm/
[Device Handling]: /es/doc/device-handling/
...
<div class="row">
  <div class="col-lg-4 col-md-4 more-bottom">
    ...
    <p>Make sure your hardware is compatible, as Qubes OS cannot run on every type of computer. Also, check out <a href="/es/doc/certified-laptops/">Qubes-certified Laptops</a>.</p>
  ...
  <div class="col-lg-4 col-md-4">
    <h2>Documentation</h2>
    <p>Peruse our extensive library of documentation for users and developers of Qubes OS. You can even help us <a href="/es/doc/doc-guidelines/">improve</a> it!</p>
