...
lang: es
layout: doc
permalink: /es/doc/backup-emergency-restore-v3/
redirect_from:
- /es/doc/BackupEmergencyRestoreV3/
ref: 201
...
============================================
<a id="emergency-backup-recovery-without-qubes-v3"></a>
...
*compressed*.
 ...
 3. Read the `backup-header`. You'll need some of this information later. The
    ...
    **Note:** If you see `version=2` here, go to [Emergency Backup Recovery -
    format version 2](/es/doc/backup-emergency-restore-v2/) instead.
