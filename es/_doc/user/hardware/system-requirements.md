...
<div class="alert alert-warning" role="alert">
  ...
  recommend consulting the <a href="/es/hcl/">Hardware Compatibility List</a> to
...
- **Graphics:** Intel integrated graphics processor (IGP) strongly recommended
  - Nvidia GPUs may require significant
    [troubleshooting](/es/doc/install-nvidia-driver/)
...
- Please see the [Hardware Compatibility List](/es/hcl/) for a compilation of
  hardware reports generated and submitted by users across various Qubes
  versions. (For more information about the HCL itself, see [here](/es/doc/hcl/).)
- See the [Certified Hardware](/es/doc/certified-hardware/) page.
- See the [Hardware Testing](/es/doc/hardware-testing/) page.
...
- Qubes **can** be installed on a USB flash drive or external disk, and testing
  ...
  [hcl-report](/es/doc/hcl/#generating-and-submitting-new-reports) for advice on
