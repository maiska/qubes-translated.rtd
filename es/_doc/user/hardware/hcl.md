 ...
 **Note:**
 ...
 Make sure it meets the [System Requirements](/es/doc/system-requirements/) and search in particular for support of:
...
Also see [Certified Hardware](/es/doc/certified-hardware/) and [Hardware Testing](/es/doc/hardware-testing/).
...
If you would like to submit your HCL report, please send the **HCL Info** `.yml` file to [\`qubes-users@googlegroups.com\`](/es/support/#qubes-users) with the subject `HCL - <your machine model name>`. Alternatively you can also create a post in the [HCL Reports category](https://qubes-os.discourse.group/c/user-support/hcl-reports/23) of the forum.
