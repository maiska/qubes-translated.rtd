...
lang: es
layout: doc
permalink: /es/doc/how-to-use-disposables/
redirect_from:
- /es/doc/DisposableVms/
- /es/doc/disposable/
- /es/doc/disposablevm/
- /es/doc/dispvm/
- /es/doc/how-to-use-disposablevms/
- /es/wiki/DisposableVMs/
ref: 203
title: How to Use Disposables
---

A [disposable](/es/doc/glossary/#disposable) is a lightweight [qube](/es/doc/glossary/#qube) that can be created quickly and will self-destruct when closed.
...
If a [disposable template](/es/doc/glossary/#disposable-template) becomes compromised, then any disposable based on that disposable template could be compromised.
...
<a id="disposables-and-local-forensics"></a>
...
<a id="disposables-and-networking"></a>

Similarly to how app qubes are based on their underlying [template](/es/doc/glossary/#template), disposables are based on their underlying [disposable template](/es/doc/glossary/#disposable-template).
...
<a id="opening-a-file-in-a-disposable-via-gui"></a>
...
<a id="opening-a-fresh-web-browser-instance-in-a-new-disposable"></a>
...
<a id="opening-a-file-in-a-disposable-via-command-line-from-app-qube"></a>
...
<a id="starting-an-arbitrary-program-in-a-disposable-from-an-app-qube"></a>
...
<a id="starting-an-arbitrary-application-in-a-disposable-via-command-line-from-dom0"></a>
...
<a id="opening-a-link-in-a-disposable-based-on-a-non-default-disposable-template-from-a-qube"></a>
...
<a id="example-of-rpc-policies-to-allow-this-behavior"></a>
...
More information about RPC policies for disposables can be found [here](/es/doc/qrexec/#qubes-rpc-administration).

## Customizing disposables
<a id="customizing-disposables"></a>
...
Full instructions can be found [here](/es/doc/disposable-customization/).