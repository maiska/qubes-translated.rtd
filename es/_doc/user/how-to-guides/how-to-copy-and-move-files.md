...
lang: es
layout: doc
permalink: /es/doc/how-to-copy-and-move-files/
redirect_from:
- /es/doc/CopyingFiles/
- /es/doc/copying-files/
- /es/wiki/CopyingFiles/
ref: 191
...
See [copying and pasting text between qubes](/es/doc/how-to-copy-and-paste-text/).
