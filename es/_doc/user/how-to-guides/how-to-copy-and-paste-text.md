...
lang: es
layout: doc
permalink: /es/doc/how-to-copy-and-paste-text/
redirect_from:
- /es/doc/CopyPaste/
- /es/doc/copy-paste/
- /es/wiki/CopyPaste/
...
If you wish to copy more complex data, such as rich text or images, see [copying and moving files between qubes](/es/doc/how-to-copy-and-move-files/).
For dom0, see [copying from (and to) dom0](/es/doc/how-to-copy-from-dom0/).*
...
The Qubes clipboard [RPC policy](/es/doc/rpc-policy/) is configurable in:
