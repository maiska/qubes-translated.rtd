...
lang: es
layout: doc
permalink: /es/doc/how-to-copy-from-dom0/
redirect_from:
- /es/doc/CopyToDomZero/
- /es/doc/copy-from-dom0/
- /es/doc/copy-to-dom0/
...
Since dom0 is special, the processes are different from [copying and pasting text between qubes](/es/doc/how-to-copy-and-paste-text/) and [copying and moving files between qubes](/es/doc/how-to-copy-and-move-files/).
...
A safer approach is simply to display the image in [full-screen mode](/es/doc/full-screen-mode/) in an app qube, then take a screenshot from dom0, which results in exactly the image needed for a wallpaper, created securely and natively in dom0.
