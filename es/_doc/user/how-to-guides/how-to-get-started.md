...
lang: es
layout: doc
permalink: /es/doc/how-to-get-started/
redirect_from:
...
After [downloading](/es/downloads/) and [installing](/es/doc/installation-guide/)
...
called [qubes](/es/doc/glossary/#qube). For example, you might have a work qube, a
...
qube](/es/doc/glossary/#app-qube), which is a qube intended for running software
programs like web browsers, email clients, and word processors. Each app qube
is based on another type of qube called a [template](/es/doc/glossary/#template).
...
qube](/es/doc/glossary/#service-qube). If you need to access USB devices, another
service qube will do that. There's also a [management
qube](/es/doc/glossary/#management-qube) that automatically handles a lot of
...
qube](/es/doc/glossary/#admin-qube) which, as the name suggests, is used to
administer your entire system. There's only one admin qube, and it's called
[dom0](/es/doc/glossary/#dom0). You can think of it as the master qube, holding
...
default desktop environment, but it also supports [KDE](/es/doc/kde/), as well as
the window managers [i3](/es/doc/i3/) and [AwesomeWM](/es/doc/awesomewm/).
...
can be found [here](/es/doc/tools/).
...
It is *very important* to [keep Qubes updated](/es/doc/how-to-update/) to ensure
...
[How-to Guides](/es/doc/#how-to-guides) section in the docs.

- [How to Update](/es/doc/how-to-update/)
- [How to Back Up, Restore, and Migrate](/es/doc/how-to-back-up-restore-and-migrate/)
- [How to Copy and Paste Text](/es/doc/how-to-copy-and-paste-text/)
- [How to Copy and Move Files](/es/doc/how-to-copy-and-move-files/)
- [How to Copy from Dom0](/es/doc/how-to-copy-from-dom0/)
- [How to Install Software](/es/doc/how-to-install-software/)
- [How to Use Devices (block storage, USB, and PCI devices)](/es/doc/how-to-use-devices/)

If you encounter any problems, please visit the [Help, Support, Mailing Lists,
and Forum](/es/support/) page.

## Compatible Hardware
<a id="compatible-hardware"></a>

Make sure your hardware satisfies the [system
requirements](/es/doc/system-requirements/), as Qubes OS cannot run on every type
of computer. You may also want to check out [Qubes-certified
Hardware](/es/doc/certified-hardware/) and take a look at the [Hardware
Compatibility List (HCL)](/es/hcl/).

## Downloads
<a id="downloads"></a>

[Download an ISO](/es/downloads/), learn how to [verify its
authenticity](/es/doc/verifying-signatures/), and follow our [guide to install
Qubes OS](/es/doc/installation-guide/). Looking for the [source
code](/es/doc/source-code/)? You'll find it [on
GitHub](https://github.com/QubesOS).

## Documentation
<a id="documentation"></a>

Peruse our extensive library of [documentation](/es/doc/) for users and developers
of Qubes OS. You can even [help us improve it](/es/doc/doc-guidelines/)!