...
lang: es
layout: doc
permalink: /es/doc/how-to-install-software/
redirect_from:
- /es/doc/SoftwareUpdateVM/
- /es/doc/software-update-domu/
- /es/doc/software-update-vm/
- /es/wiki/SoftwareUpdateVM/
ref: 189
title: How to Install Software
---

When you wish to install software in Qubes OS, you should generally install it
in a [template](/es/doc/glossary/#template).

Advanced users may also be interested in learning how to install software in
[standalones](/es/doc/standalones-and-hvms/) and
...
6. (Recommended) In the relevant qubes' **Qube Settings**, go to the
   **Applications** tab, select the new application(s) from the list, and press
   ...
   encounter problems, see [here](/es/doc/app-menu-shortcut-troubleshooting/) for
   troubleshooting.)
...
- If your software requires special files or directories to be persistent, and
  ...
  HVMs](/es/doc/standalones-and-hvms/) and [How to Make Any File Persistent
  (bind-dirs)](/es/doc/bind-dirs/).
- [Ask for help.](/es/support/)

## How to update software
<a id="how-to-update-software"></a>

Please see [How to Update](/es/doc/how-to-update/).

## Why don't templates have network access?
<a id="why-dont-templates-have-network-access"></a>
...
[standalones](/es/doc/glossary/#standalone) is the same as described above for
templates, except no qubes are based on standalones, so there are no other
qubes to restart.

### RPMFusion for Fedora templates
<a id="rpmfusion-for-fedora-templates"></a>
...
<a id="reverting-changes-to-a-template"></a>
...
framework](/es/doc/qubes-service/)):
