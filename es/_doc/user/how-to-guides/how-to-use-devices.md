...
lang: es
layout: doc
permalink: /es/doc/how-to-use-devices/
redirect_from:
- /es/doc/ExternalDeviceMountPoint/
- /es/doc/device-handling/
- /es/doc/external-device-mount-point/
- /es/wiki/ExternalDeviceMountPoint/
ref: 188
title: How to Use Devices
---

This is an overview of device handling in Qubes OS.
For specific devices ([block](/es/doc/how-to-use-block-storage-devices/), [USB](/es/doc/how-to-use-usb-devices/) and [PCI](/es/doc/how-to-use-pci-devices/) devices), please visit their respective pages.

**Important security warning:** Device handling comes with many security implications.
Please make sure you carefully read and understand the **[security considerations](/es/doc/device-handling-security/)**.
