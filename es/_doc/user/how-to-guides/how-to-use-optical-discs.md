...
lang: es
layout: doc
permalink: /es/doc/how-to-use-optical-discs/
redirect_from:
- /es/doc/optical-discs/
...
To access an optical disc via USB follow the [typical procedure for attaching a USB device](/es/doc/how-to-use-usb-devices/#with-the-command-line-tool), then check with the **Qubes Devices** widget to see what device in the target qube the USB optical drive was attached to.
