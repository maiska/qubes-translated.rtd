...
lang: es
layout: doc
permalink: /es/doc/how-to-back-up-restore-and-migrate/
redirect_from:
- /es/doc/BackupRestore/
- /es/doc/backup-restore/
...
3. Select the destination for the backup:
   ...
   backup to a [USB mass storage device](/es/doc/usb/), you can use the directory
...
2. Select the source location of the backup to be restored:
   ...
   - If your backup is located on a [USB mass storage device](/es/doc/usb/),
...
Qubes](/es/downloads/) on the new machine, and follow the restoration procedure on
