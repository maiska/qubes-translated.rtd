...
lang: es
layout: doc
permalink: /es/doc/managing-appvm-shortcuts/
redirect_from:
- /es/doc/ManagingAppVmShortcuts/
- /es/wiki/ManagingAppVmShortcuts/
ref: 202
...
============================================
<a id="managing-shortcuts-to-applications-in-appvms"></a>
...
2. Create a custom `.desktop` file in `~/.local/share/applications`.
   ...
   You may use `qvm-run` inside the `.desktop` file; see [Behind the scenes](/es/doc/managing-appvm-shortcuts/#behind-the-scenes) for more details.
...
[See here](/es/doc/disposablevm-customization/).
...
`qvm-sync-appmenus` works by invoking *GetAppMenus* [Qubes service](/es/doc/qrexec/) in the target domain.
