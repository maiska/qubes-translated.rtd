...
lang: es
layout: doc
permalink: /es/doc/pci-troubleshooting/
ref: 230
...
Both can be achieved during attachment with `qvm-pci` as described [PCI Devices documentation](/es/doc/how-to-use-pci-devices/#additional-attach-options).
...
This is a [PCI passthrough issue](/es/doc/pci-troubleshooting/#pci-passthrough-issues), which occurs when PCI arbitrator is too strict.
There is a way to enable permissive mode for it.
...
Refer to [Suspend/Resume Troubleshooting](/es/doc/suspend-resume-troubleshooting/#attached-devices-in-windows-hvm-stop-working-on-suspendresume) for a solution.
...
Look at the [FAQs](/es/faq/#i-assigned-a-pci-device-to-a-qube-then-unassigned-itshut-down-the-qube-why-isnt-the-device-available-in-dom0) to learn how to re-enable the device in dom0.
