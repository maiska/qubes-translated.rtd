...
This troubleshoot applies to the non-default kernel choice described in the [Managing VM docs](/es/doc/managing-vm-kernel/#using-kernel-installed-in-the-vm).
