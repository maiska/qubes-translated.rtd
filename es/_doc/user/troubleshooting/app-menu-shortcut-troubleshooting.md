...
lang: es
layout: doc
permalink: /es/doc/app-menu-shortcut-troubleshooting/
redirect_from:
- /es/doc/ManagingAppVmShortcuts/
- /es/doc/managing-appvm-shortcuts/
...
2. Create a custom `.desktop` file in `~/.local/share/applications`.
   ...
   You may use `qvm-run` inside the `.desktop` file; see [Behind the scenes](/es/doc/app-menu-shortcut-troubleshooting/#behind-the-scenes) for more details.
...
[See here](/es/doc/disposable-customization/).
