...
lang: es
layout: doc
permalink: /es/doc/hvm-troubleshooting/
ref: 232
...
<a id="cant-start-an-os-in-an-hvm--probing-edd-eddoff-to-disable-ok-message"></a>
...
<a id="hvm-crashes-when-booting-from-iso"></a>
...
After the whole system gets suspended into S3 sleep and subsequently resumed, some attached devices may stop working. To know how to make the devices work, see [Suspend/resume Troubleshooting](/es/doc/suspend-resume-troubleshooting/#attached-devices-in-windows-hvm-stop-working-on-suspendresume).