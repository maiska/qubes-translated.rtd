...
In [How to Get Started](/es/doc/how-to-get-started/), we covered the distinction
in Qubes OS between where you *install* your software and where you *run* your
software. Your software is installed in [templates](/es/doc/glossary/#template).
Each template shares its root filesystem (i.e., all of its programs and system
files) with all the qubes based on it. [App qubes](/es/doc/glossary/#app-qube) are
...
* [Fedora](/es/doc/templates/fedora/) (default)
* [Fedora Minimal](/es/doc/templates/minimal/)
* [Fedora Xfce](/doc/templates/xfce)
* [Debian](/es/doc/templates/debian/)
* [Debian Minimal](/es/doc/templates/minimal/)
...
* [Arch Linux](/es/doc/building-archlinux-template/)
* [CentOS](/es/doc/templates/centos/)
* [CentOS Minimal](/es/doc/templates/minimal/)
* [Gentoo](/es/doc/templates/gentoo/)
* [Gentoo Minimal](/es/doc/templates/minimal/)
...
* When a template version you're using reaches
  [end-of-life](/es/doc/supported-versions/).
...
[minimal](/es/doc/templates/minimal/) version of the template, if one exists, by
...
[here](/es/faq/#when-i-try-to-install-a-template-it-says-no-match-is-found).
...
Please see [How to Update](/es/doc/how-to-update/).
...
[VM Troubleshooting](/es/doc/vm-troubleshooting/).
...
Please see [How to Reinstall a Template](/es/doc/reinstall-template/).
...
4. Base the [disposable template](/es/doc/glossary/#disposable-template) on the new
   template.
...
|-------------------------------------------------|-----------------------------------------------------------|---------------------------------------------------------|
| [template](/es/doc/glossary/#template)             | N/A (templates cannot be based on templates)              | everything                                              |
| [app qube](/es/doc/glossary/#app-qube)<sup>3</sup> | `/etc/skel` to `/home`; `/usr/local.orig` to `/usr/local` | `/rw` (includes `/home`, `/usr/local`, and `bind-dirs`) |
| [disposable](/es/doc/glossary/#disposable)         | `/rw` (includes `/home`, `/usr/local`, and `bind-dirs`)   | nothing                                                 |

<sup>1</sup>Upon creation  
<sup>2</sup>Following shutdown  
<sup>3</sup>Includes [disposable templates](/es/doc/glossary/#disposable-template)

### Trusting your templates
<a id="trusting-your-templates"></a>
...
* Only install packages from trusted sources -- e.g. from the pre-configured
  ...
  enforced by default (at the [firewall qube level](/es/doc/firewall/)), by not
  allowing any networking connectivity in the default template, except for
  access to the Fedora repos.

* Use [standalones](/es/doc/glossary/#standalone) (see below) for installation of
...
by the [firewall qube](/es/doc/firewall/), and again they should not fear this
...
<a id="note-on-treating-app-qubes-root-filesystem-non-persistence-as-a-security-feature"></a>
...
* Some templates are available in ready-to-use binary form, but some of them
  ...
  Builder](/es/doc/qubes-builder/). In particular, some template "flavors" are
  available in source code form only. For the technical details of the template
  system, please see [Template Implementation](/es/doc/template-implementation/).
  Take a look at the [Qubes Builder](/es/doc/qubes-builder/) documentation for
