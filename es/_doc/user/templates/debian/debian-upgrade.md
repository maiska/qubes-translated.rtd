...
lang: es
layout: doc
permalink: /es/doc/template/debian/upgrade/
redirect_from:
- /es/doc/DebianTemplateUpgrade8/
- /es/doc/debian-template-upgrade-8/
- /es/doc/template/debian/upgrade-8-to-9/
- /es/wiki/DebianTemplateUpgrade8/
ref: 133
...
This page provides instructions for performing an in-place upgrade of an installed [Debian Template](/es/doc/templates/debian/).
If you wish to install a new, unmodified Debian template instead of upgrading a template that is already installed in your system, please see the [Debian Template](/es/doc/templates/debian/) page instead. ([Learn more about the two options.](/es/doc/templates/debian/#upgrading))
...
<a id="summary-instructions-for-debian-templates"></a>
...
<a id="detailed-instructions-for-debian-templates"></a>
...
9. (Recommended) [Switch everything that was set to the old template to the new template.](/es/doc/templates/#switching)
...
11. (Optional) [Uninstall the old template.](/es/doc/templates/#uninstalling)
    Make sure that the template you're uninstalling is the old one, not the new one!

## Standalones
<a id="standalones"></a>

The procedure for upgrading a Debian [standalone](/es/doc/standalone-and-hvm/) is the same as for a template.
