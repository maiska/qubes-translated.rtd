...
you can install one of the available Xfce templates for [Fedora](/es/doc/templates/fedora/), [CentOS](/es/doc/templates/centos/) or [Gentoo](/es/doc/templates/gentoo/).
...
If your desired version is not found, it may still be in [testing](/es/doc/testing/).
...
To reinstall a Xfce template that is already installed in your system, see [How to Reinstall a template](/es/doc/reinstall-template/).