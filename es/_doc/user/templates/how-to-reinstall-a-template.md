...
lang: es
layout: doc
permalink: /es/doc/how-to-reinstall-a-template/
redirect_from:
- /es/doc/reinstall-template/
- /es/doc/whonix/reinstall/
ref: 128
title: How to Reinstall a Template
---

If you suspect your [template](/es/doc/templates/) is broken, misconfigured, or compromised, you can reinstall any template that was installed from the Qubes repository.
