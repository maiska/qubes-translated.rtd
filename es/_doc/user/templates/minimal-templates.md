...
The minimal [templates](/es/doc/templates/) are lightweight versions of their
...
2. If something works with a standard template but not the minimal version,
   ...
   Forum](/es/support/) for the appropriate place to ask for help. Once you have
   learned how to solve your problem, please [contribute what you learned to
   the documentation](/es/doc/doc-guidelines/).
...
3. The minimal templates are intentionally *minimal*. [Do not ask for your
   ...
   default.](/es/faq/#could-you-please-make-my-preference-the-default)
...
[testing](/es/doc/testing/). You may wish to try again with the testing repository
enabled:
...
VMs](/es/doc/vm-sudo/) to be optional in minimal templates. Since the minimal
...
- [FirewallVM](/es/doc/firewall/), such as the template for `sys-firewall`: at
...
- [USB qube](/es/doc/usb-qubes/), such as the template for `sys-usb`:
...
Documentation on all of these can be found in the [docs](/es/doc/).
