...
This can also slightly improve security when you have a [USB keyboard](/es/doc/device-handling-security/#security-warning-on-usb-input-devices).

## Challenge-response mode
<a id="challenge-response-mode"></a>
...
<a id="mandatory-yubikey-login"></a>
...
<a id="locking-the-screen-when-yubikey-is-removed"></a>
