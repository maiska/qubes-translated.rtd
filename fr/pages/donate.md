...
<a id="join-our-sustaining-supporters"></a>
...
<a id="become-a-qubes-partner"></a>

Are you an organization, company, or individual who believes in our vision and wants to make an impact on our efforts? [Become a Qubes Partner](/fr/partners/) by giving a significant financial contribution.

## Help us spread the word
<a id="help-us-spread-the-word"></a>
...
There are also [many more ways to contribute](/fr/doc/contributing/)!

## FAQs on donating
<a id="faqs-on-donating"></a>

Frequently asked questions about Qubes donations.
Join the conversation on our [mailing lists and forum](/fr/support/).

### Why should I donate?
<a id="why-should-i-donate"></a>
...
[Here is what security and privacy experts say about the project.](/fr/experts/)
...
<a id="how-is-my-donation-used"></a>
...
<a id="do-donors-get-personalized-support-or-special-feature-requests"></a>
...
<a id="is-my-donation-tax-deductible"></a>
...
<a id="how-can-i-donate-via-eu-bank-transfer"></a>
...
<a id="can-i-donate-something-other-than-money"></a>
...
<a id="how-do-i-verify-your-bitcoin-address"></a>

The donation address can be verified via the [Qubes Security Pack](/fr/security/pack/), specifically in the [fund directory](https://github.com/QubesOS/qubes-secpack/tree/master/fund).
We provide [detailed instructions for verifying the digital signatures](/fr/security/pack/#how-to-obtain-verify-and-read).
...
<a id="how-do-i-verify-your-monero-address"></a>

The donation address can be verified via the [Qubes Security Pack](/fr/security/pack/), specifically in the [fund directory](https://github.com/QubesOS/qubes-secpack/tree/master/fund).
We provide [detailed instructions for verifying the digital signatures](/fr/security/pack/#how-to-obtain-verify-and-read).

### Is Qubes merchandise available?
<a id="is-qubes-merchandise-available"></a>
...
Visit our [introduction page to Qubes](/fr/intro/) or watch a [video overview of the system](/fr/video-tours/) to learn more.
