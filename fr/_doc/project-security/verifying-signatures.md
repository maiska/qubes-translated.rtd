...
site](/fr/faq/#should-i-trust-this-website)), dishonest IT staff at the hosting
company, dishonest staff at the ISPs, Wi-Fi attacks, etc. We call this
philosophy [Distrusting the
Infrastructure](/fr/faq/#what-does-it-mean-to-distrust-the-infrastructure).
...
Pack](/fr/security/pack/) and in the archives of the project's
...
could be compromised](/fr/faq/#should-i-trust-this-website), so the fingerprint
...
- If you have access to an existing Qubes installation, the release keys are
  ...
  [copied](/fr/doc/how-to-copy-from-dom0/#copying-from-dom0) into other VMs for
...
- Download it as a file. You can find the Release Signing Key for your Qubes
  version on the [Downloads](/fr/downloads/) page. You can also download all the
  currently used developers' signing keys, Release Signing Keys, and the Qubes
  Master Signing Key from the [Qubes Security Pack](/fr/security/pack/) and the
...
find on the [Downloads](/fr/downloads/) page alongside the ISO. If the filename of
...
the [Downloads](/fr/downloads/) page, and you can always find all the digest files
for every Qubes ISO in the [Qubes Security Pack](/fr/security/pack/).
...
Pack](/fr/security/pack/)) rather than relying on a third party, such as GitHub.
...
Please see [Help, Support, Mailing Lists, and Forum](/fr/support/) for places
where you can ask!