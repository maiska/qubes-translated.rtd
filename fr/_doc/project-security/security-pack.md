...
lang: fr
layout: doc
permalink: /fr/security/pack/
redirect_from:
- /fr/doc/SecurityPack/
- /fr/doc/qsp/
- /fr/doc/sec-pack/
- /fr/doc/secpack/
- /fr/doc/security-pack/
- /fr/qsp/
- /fr/sec-pack/
- /fr/secpack/
- /fr/security-pack/
- /fr/wiki/SecurityPack/
ref: 213
...
* [Signed Qubes ISO digests](/fr/security/verifying-signatures/#how-to-verify-qubes-iso-digests)
...
3. Verify and trust the Qubes Master Signing Key.
   ...
   **Important!**
   ...
   key verification [here](/fr/security/verifying-signatures/).
