...
lang: fr
layout: doc
permalink: /fr/doc/qubes-builder/
redirect_from:
- /fr/doc/QubesBuilder/
- /fr/wiki/QubesBuilder/
ref: 64
title: Qubes Builder
---

**Note: See [ISO building instructions](/fr/doc/qubes-iso-building/) for a streamlined overview on how to use the build system.**
...
[QubesBuilder](/fr/doc/qubes-builder/) by default verifies signed tags on every downloaded code.
...
For advanced [QubesBuilder](/fr/doc/qubes-builder/) use, and preparing sources, take a look at [QubesBuilderDetails](/fr/doc/qubes-builder-details/) page, or [QubesBuilder's doc directory](https://github.com/marmarek/qubes-builder/tree/master/doc).