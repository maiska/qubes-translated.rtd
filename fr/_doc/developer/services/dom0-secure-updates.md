...
lang: fr
layout: doc
permalink: /fr/doc/dom0-secure-updates/
redirect_from:
- /fr/doc/Dom0SecureUpdates/
- /fr/wiki/Dom0SecureUpdates/
ref: 43
...
==================================
<a id="qubes-dom0-secure-update-procedure"></a>

Reasons for Dom0 updates
------------------------
<a id="reasons-for-dom0-updates"></a>
...
---------------------------------------------------------
<a id="problems-with-traditional-network-based-update-mechanisms"></a>
...
-------------------------------------------------------------
<a id="secure-update-mechanism-we-use-in-qubes-starting-from-beta-2"></a>
...
----------------------------------------
<a id="security-benefit-of-our-update-mechanism"></a>
