...
[View this table on a fullscreen page.](/fr/doc/admin-api/table/)
...
<a id="parallel-gzip-for-faster-backup"></a>
compression: pigz

# ask 'vault' VM for the backup passphrase
<a id="ask-vault-vm-for-the-backup-passphrase"></a>
passphrase_vm: vault

# send the (encrypted) backup directly to remote server
<a id="send-the-encrypted-backup-directly-to-remote-server"></a>
