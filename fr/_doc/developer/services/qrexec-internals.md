...
lang: fr
layout: doc
permalink: /fr/doc/qrexec-internals/
redirect_from:
- /fr/doc/Qrexec3Implementation/
- /fr/doc/qrexec3-implementation/
- /fr/wiki/Qrexec3Implementation/
ref: 39
title: 'Qrexec: Qubes RPC Internals'
---

(*This page details the current implementation of qrexec (qrexec3).
A [general introduction](/fr/doc/qrexec/) to qrexec is also available.
For the implementation of qrexec2, see [here](/fr/doc/qrexec2/#qubes-rpc-internals).*)
...
<a id="dom0-tools-implementation"></a>
...
<a id="vm-tools-implementation"></a>
...
<a id="qrexec-protocol-details"></a>
...
<a id="qrexec-policy-implementation"></a>

`qrexec-policy` is a mechanism for evaluating whether an RPC call should be allowed. For introduction, see [Qubes RPC administration](/fr/doc/qrexec/#qubes-rpc-administration).

### `qrexec-policy-daemon`
<a id="qrexec-policy-daemon"></a>
...
It is a [socket-based Qubes RPC service](/fr/doc/qrexec-socket-services/). Requests are in JSON format, and response is simple ASCII.
