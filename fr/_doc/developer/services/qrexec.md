...
(*This page is about qrexec v3. For qrexec v2, see [here](/fr/doc/qrexec2/).*)
...
<a id="qrexec-basics-architecture-and-examples"></a>
...
<a id="specifying-vms-tags-types-targets-etc"></a>
...
<a id="rpc-services-and-security"></a>
...
One example of such a situation is [qrexec-based USB passthrough](/fr/doc/how-to-use-usb-devices/).
...
<a id="simple-rpc-service-addition"></a>
...
<a id="rpc-service-with-argument-file-reader"></a>
