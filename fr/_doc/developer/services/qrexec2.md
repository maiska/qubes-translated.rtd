...
lang: fr
layout: doc
permalink: /fr/doc/qrexec2/
redirect_from:
- /fr/doc/Qrexec2Implementation/
- /fr/wiki/Qrexec2Implementation/
- /fr/doc/qrexec2-implementation/
ref: 38
title: Qrexec2
---
...
(*This page is about qrexec v2. For qrexec v3, see [here](/fr/doc/qrexec3/).*)
...
qrexec v3, see [here](/fr/doc/qrexec-internals/). Note that the user
...
apps. Also note the [qrexec framework implemention in Qubes R3](/fr/doc/qrexec3/)
