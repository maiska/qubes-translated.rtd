...
Thank you for your interest in participating in the [2021 Google Season of Docs](https://developers.google.com/season-of-docs/) program with the [Qubes OS team](/fr/team/). You can read more about the Google Season of Docs in the official [guides](https://developers.google.com/season-of-docs/docs/) and [FAQ](https://developers.google.com/season-of-docs/docs/faq).

## 2021 Project Idea 
<a id="project-idea"></a>

### Qubes OS on Virtual Machines and Disposable VMs documentation - Qubes OS
<a id="qubes-os-on-virtual-machines-and-disposable-vms-documentation---qubes-os"></a>

#### About your organization
<a id="about-your-organization"></a>
...
<a id="measuring-the-projects-success"></a>
...
<a id="consolidate-troubleshooting-guides"></a>
...
- Review existing [troubleshooting guides](/fr/doc/#troubleshooting)
...
<a id="improve-getting-started-page"></a>
...
**Mentor**: [Michael Carbone](/fr/team/)

### Rewrite qrexec documentation
<a id="rewrite-qrexec-documentation"></a>
