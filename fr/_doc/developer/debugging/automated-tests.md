...
lang: fr
layout: doc
permalink: /fr/doc/automated-tests/
redirect_from:
- /fr/doc/AutomatedTests/
ref: 45
...
<a id="integration--unit-testing-in-dom0"></a>
...
The below example however will assume that you set up a build environment as described in the [Qubes Builder documentation](/fr/doc/qubes-builder/).
...
<a id="adding-a-new-test-to-core-admin"></a>
...
<a id="testing-pyqt-applications"></a>
...
<a id="installation-tests-with-openqa"></a>
