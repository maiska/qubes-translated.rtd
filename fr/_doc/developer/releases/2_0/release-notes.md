...
Upgrading from Qubes R2 rc1 should be a simple matter of installing updates for [dom0](/fr/doc/how-to-install-software-in-dom0/) and [VMs](/fr/doc/software-update-vm/).
