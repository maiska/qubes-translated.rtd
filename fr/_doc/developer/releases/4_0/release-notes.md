...
lang: fr
layout: doc
permalink: /fr/doc/releases/4.0/release-notes/
ref: 23
...
* New [backup format](/fr/doc/backup-emergency-restore-v4/) using scrypt key-derivation function
...
* [More flexible firewall interface](/fr/doc/vm-interface/) for ease unikernel integration
...
* More flexible Qubes RPC policy - [related ticket](https://github.com/QubesOS/qubes-issues/issues/865), [documentation](/fr/doc/qrexec/#specifying-vms-tags-types-targets-etc)
...
[qubes backup and restore tools](/fr/doc/backup-restore/) for migrating of all of the user VMs.
We also provide [detailed instruction](/fr/doc/upgrade-to-r4.0/) for this procedure.