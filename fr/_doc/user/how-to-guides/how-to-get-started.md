...
lang: fr
layout: doc
permalink: /fr/doc/how-to-get-started/
redirect_from:
...
After [downloading](/fr/downloads/) and [installing](/fr/doc/installation-guide/)
...
called [qubes](/fr/doc/glossary/#qube). For example, you might have a work qube, a
...
qube](/fr/doc/glossary/#app-qube), which is a qube intended for running software
programs like web browsers, email clients, and word processors. Each app qube
is based on another type of qube called a [template](/fr/doc/glossary/#template).
...
qube](/fr/doc/glossary/#service-qube). If you need to access USB devices, another
service qube will do that. There's also a [management
qube](/fr/doc/glossary/#management-qube) that automatically handles a lot of
...
qube](/fr/doc/glossary/#admin-qube) which, as the name suggests, is used to
administer your entire system. There's only one admin qube, and it's called
[dom0](/fr/doc/glossary/#dom0). You can think of it as the master qube, holding
...
default desktop environment, but it also supports [KDE](/fr/doc/kde/), as well as
the window managers [i3](/fr/doc/i3/) and [AwesomeWM](/fr/doc/awesomewm/).
...
can be found [here](/fr/doc/tools/).
...
It is *very important* to [keep Qubes updated](/fr/doc/how-to-update/) to ensure
...
[How-to Guides](/fr/doc/#how-to-guides) section in the docs.

- [How to Update](/fr/doc/how-to-update/)
- [How to Back Up, Restore, and Migrate](/fr/doc/how-to-back-up-restore-and-migrate/)
- [How to Copy and Paste Text](/fr/doc/how-to-copy-and-paste-text/)
- [How to Copy and Move Files](/fr/doc/how-to-copy-and-move-files/)
- [How to Copy from Dom0](/fr/doc/how-to-copy-from-dom0/)
- [How to Install Software](/fr/doc/how-to-install-software/)
- [How to Use Devices (block storage, USB, and PCI devices)](/fr/doc/how-to-use-devices/)

If you encounter any problems, please visit the [Help, Support, Mailing Lists,
and Forum](/fr/support/) page.

## Compatible Hardware
<a id="compatible-hardware"></a>

Make sure your hardware satisfies the [system
requirements](/fr/doc/system-requirements/), as Qubes OS cannot run on every type
of computer. You may also want to check out [Qubes-certified
Hardware](/fr/doc/certified-hardware/) and take a look at the [Hardware
Compatibility List (HCL)](/fr/hcl/).

## Downloads
<a id="downloads"></a>

[Download an ISO](/fr/downloads/), learn how to [verify its
authenticity](/fr/doc/verifying-signatures/), and follow our [guide to install
Qubes OS](/fr/doc/installation-guide/). Looking for the [source
code](/fr/doc/source-code/)? You'll find it [on
GitHub](https://github.com/QubesOS).

## Documentation
<a id="documentation"></a>

Peruse our extensive library of [documentation](/fr/doc/) for users and developers
of Qubes OS. You can even [help us improve it](/fr/doc/doc-guidelines/)!