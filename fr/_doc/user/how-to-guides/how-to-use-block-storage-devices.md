...
lang: fr
layout: doc
permalink: /fr/doc/how-to-use-block-storage-devices/
redirect_from:
- /fr/doc/StickMounting/
- /fr/doc/block-devices/
- /fr/doc/stick-mounting/
- /fr/wiki/StickMounting/
ref: 193
...
Entries starting with a number (e.g. here `2-1`) are the [whole usb-device](/fr/doc/how-to-use-usb-devices/).
