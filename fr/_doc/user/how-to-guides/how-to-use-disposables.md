...
lang: fr
layout: doc
permalink: /fr/doc/how-to-use-disposables/
redirect_from:
- /fr/doc/DisposableVms/
- /fr/doc/disposable/
- /fr/doc/disposablevm/
- /fr/doc/dispvm/
- /fr/doc/how-to-use-disposablevms/
- /fr/wiki/DisposableVMs/
ref: 203
title: How to Use Disposables
---

A [disposable](/fr/doc/glossary/#disposable) is a lightweight [qube](/fr/doc/glossary/#qube) that can be created quickly and will self-destruct when closed.
...
If a [disposable template](/fr/doc/glossary/#disposable-template) becomes compromised, then any disposable based on that disposable template could be compromised.
...
Similarly to how app qubes are based on their underlying [template](/fr/doc/glossary/#template), disposables are based on their underlying [disposable template](/fr/doc/glossary/#disposable-template).
...
More information about RPC policies for disposables can be found [here](/fr/doc/qrexec/#qubes-rpc-administration).
...
Full instructions can be found [here](/fr/doc/disposable-customization/).