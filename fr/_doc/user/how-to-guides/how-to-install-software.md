...
lang: fr
layout: doc
permalink: /fr/doc/how-to-install-software/
redirect_from:
- /fr/doc/SoftwareUpdateVM/
- /fr/doc/software-update-domu/
...
in a [template](/fr/doc/glossary/#template).

Advanced users may also be interested in learning how to install software in
[standalones](/fr/doc/standalones-and-hvms/) and
...
6. (Recommended) In the relevant qubes' **Qube Settings**, go to the
   **Applications** tab, select the new application(s) from the list, and press
   ...
   encounter problems, see [here](/fr/doc/app-menu-shortcut-troubleshooting/) for
   troubleshooting.)
...
- If your software requires special files or directories to be persistent, and
  ...
  HVMs](/fr/doc/standalones-and-hvms/) and [How to Make Any File Persistent
  (bind-dirs)](/fr/doc/bind-dirs/).
- [Ask for help.](/fr/support/)
...
[standalones](/fr/doc/glossary/#standalone) is the same as described above for
...
framework](/fr/doc/qubes-service/)):
