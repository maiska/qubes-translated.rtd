...
lang: fr
layout: doc
permalink: /fr/doc/firewall/
redirect_from:
- /fr/doc/QubesFirewall/
- /fr/wiki/QubesFirewall/
- /fr/doc/qubes-firewall/
ref: 166
...
----------------------------------
<a id="understanding-firewalling-in-qubes"></a>
...
Connections to Updates Proxy are not made over a network so can not be allowed or blocked with firewall rules, but are controlled using the relevant policy file (see [R4.0 Updates proxy](/fr/doc/software-update-vm/) for more detail).
...
-------------------------------------
<a id="reconnecting-qubes-after-a-netvm-reboot"></a>
...
-------------------------------------
<a id="enabling-networking-between-two-qubes"></a>
...
--------------------------------------------------------
<a id="opening-a-single-tcp-port-to-other-network-isolated-qube"></a>
...
------------------------------------------------
<a id="port-forwarding-to-a-qube-from-the-outside-world"></a>
...
Implicit in the above example [scripts](/fr/doc/config-files/), but worth calling attention to: for all qubes *except* those supplying networking, iptables commands should be added to the `/rw/config/rc.local` script.
...
------------------------
<a id="firewall-troubleshooting"></a>
