...
lang: fr
layout: doc
permalink: /fr/doc/troubleshooting/updating-debian-and-whonix/
ref: 98
...
Despite Qubes shipping with [Debian Templates](/fr/doc/templates/debian/), most of Qubes core components run on Fedora and thus our documentation has better coverage for Fedora. However, Qubes has been working closely with the [Whonix](https://whonix.org) project which is based on Debian.
