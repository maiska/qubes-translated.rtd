...
lang: fr
layout: doc
permalink: /fr/doc/gui-troubleshooting/
ref: 233
...
The solution to this problem is to increase the minimum size of the video RAM buffer, as explained in [GUI Configuration](/fr/doc/gui-configuration/#video-ram-adjustment-for-high-resolution-displays).

## Screen blanks / Weird computer glitches like turning partially black or black boxes
<a id="screen-blanks--weird-computer-glitches-like-turning-partially-black-or-black-boxes"></a>
...
<a id="post-installation-screen-goes-black-and-freezes-following-luks-decryption"></a>
...
<a id="can-start-vm-but-cant-launch-any-applications"></a>
...
<a id="disable-audited-messages"></a>
