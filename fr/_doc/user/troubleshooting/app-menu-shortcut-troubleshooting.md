...
lang: fr
layout: doc
permalink: /fr/doc/app-menu-shortcut-troubleshooting/
redirect_from:
- /fr/doc/ManagingAppVmShortcuts/
- /fr/doc/managing-appvm-shortcuts/
...
2. Create a custom `.desktop` file in `~/.local/share/applications`.
   ...
   You may use `qvm-run` inside the `.desktop` file; see [Behind the scenes](/fr/doc/app-menu-shortcut-troubleshooting/#behind-the-scenes) for more details.
...
[See here](/fr/doc/disposable-customization/).
