...
lang: fr
layout: doc
permalink: /fr/doc/template/debian/upgrade/
redirect_from:
- /fr/doc/DebianTemplateUpgrade8/
- /fr/doc/debian-template-upgrade-8/
- /fr/doc/template/debian/upgrade-8-to-9/
- /fr/wiki/DebianTemplateUpgrade8/
ref: 133
...
This page provides instructions for performing an in-place upgrade of an installed [Debian Template](/fr/doc/templates/debian/).
If you wish to install a new, unmodified Debian template instead of upgrading a template that is already installed in your system, please see the [Debian Template](/fr/doc/templates/debian/) page instead. ([Learn more about the two options.](/fr/doc/templates/debian/#upgrading))
...
9. (Recommended) [Switch everything that was set to the old template to the new template.](/fr/doc/templates/#switching)
...
11. (Optional) [Uninstall the old template.](/fr/doc/templates/#uninstalling)
    Make sure that the template you're uninstalling is the old one, not the new one!

## Standalones
<a id="standalones"></a>

The procedure for upgrading a Debian [standalone](/fr/doc/standalone-and-hvm/) is the same as for a template.
