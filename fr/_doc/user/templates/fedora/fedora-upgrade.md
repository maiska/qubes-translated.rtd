...
This page provides instructions for performing an in-place upgrade of an installed [Fedora Template](/fr/doc/templates/fedora/).
If you wish to install a new, unmodified Fedora template instead of upgrading a template that is already installed in your system, please see the [Fedora Template](/fr/doc/templates/fedora/) page instead. ([Learn more about the two options.](/fr/doc/templates/fedora/#upgrading))
...
**Recommended:** [Switch everything that was set to the old template to the new template.](/fr/doc/templates/#switching)
...
3. Attempt the upgrade process in the new template.
    ...
    **Note:** If you encounter no errors, proceed to step 4.
     ...
     * `dnf` may complain:
       ...
       In this case, one option is to [resize the template's disk image](/fr/doc/resize-disk-image/) before reattempting the upgrade process.
...
5. (Optional) Trim the new template.
    (This should [no longer be necessary](/fr/doc/templates/#important-notes), but it does not hurt.
...
8. (Recommended) [Switch everything that was set to the old template to the new template.](/fr/doc/templates/#switching)
...
10. (Optional) [Uninstall the old template.](/fr/doc/templates/#uninstalling)
...
The procedure for upgrading a Fedora [standalone](/fr/doc/standalone-and-hvm/) is the same as for a template.
...
Also see [supported versions](/fr/doc/supported-versions/).
...
1. [Increase the template's disk image size](/fr/doc/resize-disk-image/).
...
4. Do not perform an in-place upgrade, see [Upgrading Fedora templates](/fr/doc/templates/fedora/#upgrading).