...
you can install one of the available Xfce templates for [Fedora](/fr/doc/templates/fedora/), [CentOS](/fr/doc/templates/centos/) or [Gentoo](/fr/doc/templates/gentoo/).
...
If your desired version is not found, it may still be in [testing](/fr/doc/testing/).
...
To reinstall a Xfce template that is already installed in your system, see [How to Reinstall a template](/fr/doc/reinstall-template/).