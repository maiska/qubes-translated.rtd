...
<a id="disposablevms-and-local-forensics"></a>
...
<a id="disposablevms-and-networking"></a>

Similarly to how AppVMs are based on their underlying [TemplateVM](/fr/doc/glossary/#templatevm), DisposableVMs are based on their underlying [DisposableVM Template](/fr/doc/glossary/#disposablevm-template).
...
<a id="opening-a-file-in-a-disposablevm-via-gui"></a>
...
<a id="opening-a-fresh-web-browser-instance-in-a-new-disposablevm"></a>
...
<a id="opening-a-file-in-a-disposablevm-via-command-line-from-appvm"></a>
...
<a id="starting-an-arbitrary-program-in-a-disposablevm-from-an-appvm"></a>
...
<a id="starting-an-arbitrary-application-in-a-disposablevm-via-command-line-from-dom0"></a>
...
<a id="opening-a-link-in-a-disposablevm-based-on-a-non-default-disposablevm-template-from-a-qube"></a>
...
<a id="customizing-disposablevms"></a>
...
Full instructions can be found [here](/fr/doc/disposablevm-customization/).

[DisposableVM Template]: /fr/doc/glossary/#disposablevm-template
[qrexec]: /fr/doc/qrexec/#qubes-rpc-administration