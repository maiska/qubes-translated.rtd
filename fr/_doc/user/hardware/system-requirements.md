...
<div class="alert alert-warning" role="alert">
  ...
  We strongly recommend consulting the <a href="/fr/hcl/">Hardware Compatibility List</a> to verify that Qubes can install and run on your specific model in the ways you need it to.
</div>
...
[nvidia]: /fr/doc/install-nvidia-driver/
...
[hcl-doc]: /fr/doc/hcl/
[hcl-report]: /fr/doc/hcl/#generating-and-submitting-new-reports
