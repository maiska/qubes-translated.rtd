...
The tested hardware described on this page differs from [Qubes Certified Hardware](/fr/doc/certified-hardware/) in a few key ways:
...
- [Qubes Certified Hardware](/fr/doc/certified-hardware/) --- Qubes developer certified, officially recommended
- Hardware Testing (this page) --- Qubes developer tested, unofficially recommended
- [Hardware Compatibility List (HCL)](/fr/hcl/) --- community test results, neither recommended nor disrecommended
