...
lang: fr
layout: doc
permalink: /fr/doc/upgrade-to-r3.1/
redirect_from:
- /fr/doc/UpgradeToR3.1/
- /fr/doc/UpgradeToR3.1rc1/
ref: 155
title: Upgrading to R3.1
---

**Before attempting either an in-place upgrade or a clean installation, we
strongly recommend that users [back up their systems](/fr/doc/backup-restore/).**
...
found [here](/fr/doc/software-update-vm/). The steps described in this
...
[User FAQ](/fr/faq/#i-created-a-usb-vm-and-assigned-usb-controllers-to-it-now-the-usb-vm-wont-boot)
for details.
