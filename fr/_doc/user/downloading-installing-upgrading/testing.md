...
which you can [contribute](/fr/doc/contributing/) to the Qubes OS Project. There
...
* Use [qubes-builder](/fr/doc/qubes-builder/) to build the latest release.
...
Please make sure to [report any bugs you encounter](/fr/doc/issue-tracking/).

See [Version Scheme](/fr/doc/version-scheme/) for details about release versions
and schedules. See [Release Checklist](/fr/doc/releases/todo/) for details about
the RC process.
...
* Enable [dom0 testing
  repositories](/fr/doc/how-to-install-software-in-dom0/#testing-repositories).
* Enable [template testing
  repositories](/fr/doc/how-to-install-software/#testing-repositories).
...
bug](/fr/doc/issue-tracking/) in a package that is in a testing repository, please
