...
lang: fr
layout: doc
permalink: /fr/doc/installation-guide/
redirect_from:
- /fr/doc/InstallationGuideR2B2/
- /fr/doc/InstallationGuide/
- /fr/doc/InstallationGuideR1/
- /fr/doc/InstallationGuideR2rc2/
- /fr/doc/live-usb/
- /fr/doc/InstallationGuideR2B3/
- /fr/doc/InstallationGuideR2B1/
- /fr/doc/InstallationGuideR2rc1/
- /fr/doc/InstallationGuideR3.0rc1/
- /fr/doc/InstallationGuideR3.0rc2/
- /fr/wiki/InstallationGuide/
ref: 153
...
<div class="alert alert-danger" role="alert">
  ...
  See <a href="/fr/doc/install-security/">installation security</a> for more information.
</div>
...
<div class="alert alert-danger" role="alert">
  ...
  Regardless of how you acquire your Qubes ISO, <a href="/fr/security/verifying-signatures/">verify its authenticity</a> before continuing.
</div>
...
<div class="alert alert-warning" role="alert">
  <i class="fa fa-exclamation-circle"></i>
  <b>Note:</b> There are important <a href="/fr/doc/install-security/">security considerations</a> to keep in mind when choosing an installation medium.
</div>
...
The Qubes OS Project occasionally issues [Qubes Security Bulletins (QSBs)](/fr/security/bulletins/) as part of the [Qubes Security Pack (qubes-secpack)](/fr/security/pack/).
...
For this reason, we strongly recommend that every Qubes user subscribe to the [qubes-announce](/fr/support/#qubes-announce) mailing list.

In addition to QSBs, the Qubes OS Project also publishes [Canaries](/fr/security/canaries/), XSA summaries, TemplateVM releases and end-of-life notices, and other items of interest to Qubes users.
Since these are not essential for all Qubes users to read, they are not sent to [qubes-announce](/fr/support/#qubes-announce) in order to keep the volume on that list low.
However, we expect that most users, especially novice users, will find them helpful.
If you are interested in these additional items, we encourage you to subscribe to the [Qubes News RSS feed](/feed.xml) or join one of our other [venues](/fr/support/), where these news items are also announced.

For more information about Qubes OS Project security, please see the [security center](/fr/security/).
...
[live USB]: /fr/doc/live-usb/
[downloads]: /fr/downloads/
[verifying signatures]: /fr/security/verifying-signatures/
[security considerations]: /fr/doc/install-security/
[Custom Installation]: /fr/doc/custom-install/
[Upgrade Guides]: /fr/doc/upgrade/
[Rufus]: https://rufus.akeo.ie/
[documentation]: /fr/doc/
[improving]: /fr/doc/doc-guidelines/
[Help, Support, Mailing Lists, and Forum]: /fr/support/
[update]: /fr/doc/updating-qubes-os/
[Qubes backup system]: /fr/doc/backup-restore/
[Common Tasks]: /fr/doc/#common-tasks
[Managing Operating Systems within Qubes]: /fr/doc/#managing-operating-systems-within-qubes
[installation security]: /fr/doc/install-security/
...
[advanced configuration]: /fr/doc/#advanced-configuration
[hcl-howto]: /fr/doc/hcl/#generating-and-submitting-new-reports
[Get Started]: /fr/getting-started/