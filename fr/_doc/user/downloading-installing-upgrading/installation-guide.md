...
Qubes OS has very specific [system requirements](/fr/doc/system-requirements/). To
ensure compatibility, we strongly recommend using [Qubes-certified
hardware](/fr/doc/certified-hardware/). Other hardware may require you to perform
...
Start by [downloading](/fr/downloads/) a Qubes ISO.
...
<div class="alert alert-danger" role="alert">
  ...
  href="/fr/security/verifying-signatures/">verify its authenticity</a> before
  continuing.
</div>
...
[downloads](/fr/downloads/) page by hovering over the download button.

<div class="alert alert-warning" role="alert">
  <i class="fa fa-exclamation-circle"></i>
  <b>Note:</b> There are important <a href="/fr/doc/install-security/">security
...
please see [custom installation](/fr/doc/custom-install/). Otherwise, follow the
instructions below.
...
* **Debian:** Select this option if you would like to use
  [Debian](/fr/doc/templates/debian/) qubes in addition to the default Fedora
  qubes.
* **Whonix:** Select this option if you would like to use
  [Whonix](/fr/doc/whonix/) qubes. Whonix allows you to use
...
these and other [templates](/fr/doc/templates/) later. If you're short on disk
...
[Advanced Topics](/fr/doc/#advanced-topics)).
...
Next, [update](/fr/doc/how-to-update/) your installation to ensure you have
...
(QSBs)](/fr/security/qsb/) as part of the [Qubes Security Pack
(qubes-secpack)](/fr/security/pack/). It is important to make sure that you
...
[qubes-announce](/fr/support/#qubes-announce) mailing list.

In addition to QSBs, the Qubes OS Project also publishes
[Canaries](/fr/security/canary/), XSA summaries, template releases and
...
[qubes-announce](/fr/support/#qubes-announce) in order to keep the volume on that
...
of our other [venues](/fr/support/), where these news items are also announced.
...
system](/fr/doc/how-to-back-up-restore-and-migrate/) allows you to do this
securely and easily.
...
report](/fr/doc/hcl/#generating-and-submitting-new-reports).

### Get Started
<a id="get-started"></a>

Find out [How to Get Started](/fr/doc/how-to-get-started/) with Qubes, check out
the other [How-to Guides](/fr/doc/#how-to-guides), and learn about
[Templates](/fr/doc/#templates).

## Getting help
<a id="getting-help"></a>

* We work very hard to make the [documentation](/fr/doc/) accurate, comprehensive
  ...
  [improving](/fr/doc/doc-guidelines/) it!)
...
* If you don't find your answer in the documentation, please see [Help,
  Support, Mailing Lists, and Forum](/fr/support/) for places to ask.
...
* Please do **not** email individual members of the Qubes team with questions
  ...
  Mailing Lists, and Forum](/fr/support/) for appropriate places to ask questions.