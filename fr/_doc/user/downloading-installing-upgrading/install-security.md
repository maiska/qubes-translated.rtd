...
lang: fr
layout: doc
permalink: /fr/doc/install-security/
redirect_from:
- /fr/doc/InstallSecurity/
- /fr/wiki/InstallSecurity/
ref: 149
...
(Tools like [Anti Evil Maid (AEM)](/fr/doc/anti-evil-maid/) can help with *maintaining* the trustworthiness of your hardware, but not with establishing it in the first place.)
...
You should [verify](/fr/security/verifying-signatures/) the PGP signature on your Qubes ISO before you install from it.
...
* Works via USB, including with a [USB qube](/fr/doc/usb-qubes/#creating-and-using-a-usb-qube).
* Non-fixed capacity.
