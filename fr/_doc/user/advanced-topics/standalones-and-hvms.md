...
lang: fr
layout: doc
permalink: /fr/doc/standalones-and-hvms/
redirect_from:
- /fr/doc/HvmCreate/
- /fr/doc/hvm-create/
- /fr/doc/hvm/
- /fr/doc/standalone-and-hvm/
- /fr/doc/standalones-and-hvm/
- /fr/wiki/HvmCreate/
ref: 130
title: Standalones and HVMs
---

A [standalone](/fr/doc/glossary/#standalone) is a type of qube that is created by
cloning a [template](/fr/doc/glossary/#template). Unlike templates, however,
...
Meanwhile, a [Hardware-assisted Virtual Machine (HVM)](/fr/doc/glossary/#hvm),
...
independent qube. See [How to Update](/fr/doc/how-to-update/).
...
Qubes are template-based (i.e., [app qubes](/fr/doc/glossary/#app-qube) by
...
[keys](/fr/doc/vm-interface/#qubesdb) exposed by dom0 to the qube). Such
...
[netvm](/fr/doc/glossary/#netvm).) In this instance, our DHCP server is not
useful.
...
support](/fr/doc/networking/#ipv6) for IPv6 forwarding.
...
devices](/fr/doc/how-to-use-pci-devices/) just like normal app qubes. For example,
