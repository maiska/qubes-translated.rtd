...
lang: fr
layout: doc
permalink: /fr/doc/how-to-install-software-in-dom0/
redirect_from:
- /fr/doc/SoftwareUpdateDom0/
- /fr/doc/software-update-dom0/
- /fr/wiki/SoftwareUpdateDom0/
ref: 194
...
There are three Qubes dom0 [testing](/fr/doc/testing/) repositories:
...
packages](/fr/doc/installing-contributed-packages/).
...
- `kernel`: an older LTS kernel that has passed Qubes [testing](/fr/doc/testing/)
  (the default dom0 kernel)
- `kernel-latest`: the latest release from kernel.org that has passed Qubes
  [testing](/fr/doc/testing/) (useful for [troubleshooting newer
  hardware](/fr/doc/newer-hardware-troubleshooting/))
...
[Managing VM kernel](/fr/doc/managing-vm-kernels/) for more information.
...
Requires installed [Whonix](/fr/doc/privacy/whonix/).
