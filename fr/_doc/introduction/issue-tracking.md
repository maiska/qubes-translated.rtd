...
lang: fr
layout: doc
permalink: /fr/doc/issue-tracking/
redirect_from:
- /fr/bug-report/
- /fr/bug-reports/
- /fr/bug/
...
Guidelines](/fr/doc/doc-guidelines/) for instructions on how to do so. If it's
...
2. [Search through the existing issues](#search-tips), both open and closed, to
   ...
   duplicate.](/fr/doc/issue-tracking/#new-issues-should-not-be-duplicates-of-existing-issues)
...
closed](/fr/doc/issue-tracking/#how-issues-get-closed) for details about when,
...
lists (see [Help, Support, Mailing Lists, and Forum](/fr/support/)). You can
...
Support, Mailing Lists, and Forum](/fr/support/) for appropriate place to ask
...
Forum](/fr/support/) for the appropriate place to post it. If your issue would be
...
information out of dom0](/fr/doc/how-to-copy-from-dom0/)). If your issue is
...
List (HCL) report](/fr/doc/hcl/#generating-and-submitting-new-reports), then
...
[testing](/fr/doc/testing/) repository, please reference the appropriate issue in
...
appropriate [testing](/fr/doc/testing/) repository, then to the appropriate stable
repository. If you so choose, you can test the fix while it's in the
[testing](/fr/doc/testing/) repository, or you can wait for it to land in the
