...
* Audit the [source code](/fr/doc/source-code/)
* [Report security issues](/fr/security/)
* [Send patches](/fr/doc/source-code/#how-to-send-patches) to fix bugs or
  implement features
* [Contribute packages](/doc/package-contributions)
* [Report bugs](/fr/doc/issue-tracking/)
* [Test new releases and updates](/fr/doc/testing/)
* Submit [HCL reports](/fr/doc/hcl/) for your hardware
* Record [video tours](/fr/video-tours/)
...
* [Donate](/fr/donate/) to the project
* If you represent an organization, become a [Qubes partner](/fr/partners/)
* Add a [Qubes download mirror](/fr/downloads/mirrors/)
* Answer questions and discuss Qubes on the [mailing lists](/fr/support/) and
  [forum](/fr/support/#forum)
...
preferably via the [qubes-devel](/fr/support/#qubes-devel) mailing list. Once
