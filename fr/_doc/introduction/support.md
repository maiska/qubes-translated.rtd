...
Conduct](/fr/code-of-conduct/).

## How to get help and support
<a id="how-to-get-help-and-support"></a>

First, let's see what kind of help you need.

### I would like to report a security vulnerability
<a id="i-would-like-to-report-a-security-vulnerability"></a>

That sounds more like you helping us! Thanks! Please see [Reporting Security
Issues in Qubes OS](/fr/security/#reporting-security-issues-in-qubes-os).

### I have a problem or a question
<a id="i-have-a-problem-or-a-question"></a>

No worries! Here's how we recommend proceeding:

1. Check the [documentation](/fr/doc/). There may already be a page about it.
   Specifically, check out the [How-to Guides](/fr/doc/#how-to-guides) and
   [Troubleshooting](/fr/doc/#troubleshooting) sections.

2. Search the [FAQ](/fr/faq/). Your question might already be answered.

3. Try [searching the issue tracker](/fr/doc/issue-tracking/#search-tips). There
...
<a id="i-didnt-find-a-solution-or-an-answer"></a>
...
<a id="i-dont-need-support-but-i-think-i-found-a-bug"></a>

We'd be grateful if you reported it (but please make sure no one else has
already reported it first)! Please see [Issue Tracking](/fr/doc/issue-tracking/)
for details.

### I don't need support, but I'd like to request a feature
<a id="i-dont-need-support-but-id-like-to-request-a-feature"></a>

No promises, but we'd be happy to consider it! Please see [Issue
Tracking](/fr/doc/issue-tracking/) for details.

### I just want to discuss Qubes!
<a id="i-just-want-to-discuss-qubes"></a>
...
<a id="how-can-i-get-involved-and-contribute"></a>

Thank you for asking! Please see [How to Contribute](/fr/doc/contributing/) for
...
our [Code of Conduct](/fr/code-of-conduct/). Be friendly and open, but do not
...
the [Qubes team](/fr/team/) anywhere on the Internet. Please don't assume that
...
message](/fr/security/verifying-signatures/). (But bear in mind that anyone can
...
[verification](/fr/security/verifying-signatures/) is what counts.) All official
[news](/news/) can be authenticated by [verifying the
signatures](/fr/security/verifying-signatures/) on the relevant tags or commits in
...
themselves knowledgeable through their [contributions](/fr/doc/contributing/) to
...
contributions](/fr/doc/code-signing/).

For example, you might find it easier to trust advice from someone who has a
proven track record of [contributing software
packages](/fr/doc/package-contributions/) or [contributing to the
documentation](/fr/doc/doc-guidelines/). It's unlikely that individuals who have
...
position to [verify](/fr/security/verifying-signatures/) that these came from the
same keyholder.
...
<a id="be-polite-and-respectful"></a>
...
report](/fr/doc/hcl/#generating-and-submitting-new-reports), then linking to it in
...
<a id="be-a-good-community-member"></a>
...
integration of Qubes with [Whonix](/fr/doc/whonix/), we understand better than
...
of Conduct](/fr/code-of-conduct/) for more information.

### Report issues and submit changes in the right places
<a id="report-issues-and-submit-changes-in-the-right-places"></a>
...
that you submit it to our [issue tracker](/fr/doc/issue-tracking/) so that it
doesn't get overlooked. (However, please remember that [the issue tracker is
not a discussion
forum](/fr/doc/issue-tracking/#the-issue-tracker-is-not-a-discussion-forum).)
...
change](/fr/doc/doc-guidelines/).

### Moderation
<a id="moderation"></a>

The moderation team aims to enforce our [Code of Conduct](/fr/code-of-conduct/).
...
<a id="use-proper-subject-lines"></a>
...
infrastructure](/fr/faq/#what-does-it-mean-to-distrust-the-infrastructure). This
is why, for example, we encourage discussants to use [Split
GPG](/fr/doc/split-gpg/) to sign all of their messages to the lists, but we do not
...
[Qubes Security Bulletins (QSBs)](/fr/security/qsb/), new stable releases,
...
* The [Installation Guide](/fr/doc/installation-guide/), [System
  Requirements](/fr/doc/system-requirements/), and [HCL](/fr/doc/hcl/) (for problems
  related to installing Qubes OS)
* The [User FAQ](/fr/faq/#users)
* The [documentation](/fr/doc/) (for questions about how to use Qubes OS)
...
<a id="why-was-this-forum-created"></a>
...
<a id="how-is-this-different-from-our-mailing-lists"></a>
...
<a id="does-this-split-the-community"></a>
