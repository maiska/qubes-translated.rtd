...
lang: de
layout: doc
permalink: /de/doc/qrexec-socket-services/
ref: 42
...
*This page describes how to implement and use new socket-backed services for qrexec. See [qrexec](/de/doc/qrexec/) for general overview of the qrexec framework.*
...
* [Qrexec overview](/de/doc/qrexec/)
* [Qrexec internals](/de/doc/qrexec-internals/)
