...
For example, Qubes OS may use a popular Linux distribution for an official [TemplateVM](/de/doc/templates/).
...
[external documentation]: /de/doc/#external-documentation
