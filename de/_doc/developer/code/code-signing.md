...
All contributions to the Qubes OS [source code](/de/doc/source-code/) must be cryptographically signed by the author's PGP key.
...
If you're submitting a patch by emailing the [developer mailing list](/de/support/#qubes-devel), simply sign your email with your PGP key.
