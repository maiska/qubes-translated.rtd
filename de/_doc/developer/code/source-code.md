...
If you use [qubes builder](/de/doc/QubesBuilder/) you can specify *what* you want to build, and download only the repositories needed to build that target.
...
If you want to [contribute code](/de/doc/contributing/#contributing-code) to the project, there are two ways. Whichever
method you choose, you must [sign your code](/de/doc/code-signing/) before it can be accepted.
...
* **Preferred**: Use GitHub's [fork & pull requests](https://guides.github.com/activities/forking/).
   ...
   a message to the [qubes-devel mailing list](/de/support/#qubes-devel) in order to notify people who
   do not receive GitHub notifications.

* Send a patch to the [qubes-devel mailing list](/de/support/#qubes-devel) (`git format-patch`).
