...
* New [backup format](/de/doc/backup-emergency-restore-v4/) using scrypt key-derivation function
...
* [More flexible firewall interface](/de/doc/vm-interface/) for ease unikernel integration
...
* More flexible Qubes RPC policy - [related ticket](https://github.com/QubesOS/qubes-issues/issues/865), [documentation](/de/doc/qrexec/#specifying-vms-tags-types-targets-etc)
...
[qubes backup and restore tools](/de/doc/backup-restore/) for migrating of all of the user VMs.
We also provide [detailed instruction](/de/doc/upgrade-to-r4.0/) for this procedure.