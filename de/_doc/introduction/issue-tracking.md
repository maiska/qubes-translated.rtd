...
lang: de
layout: doc
permalink: /de/doc/issue-tracking/
redirect_from:
- /de/bug-report/
- /de/bug-reports/
- /de/bug/
...
Guidelines](/de/doc/doc-guidelines/) for instructions on how to do so. If it's
...
2. [Search through the existing issues](#search-tips), both open and closed, to
   ...
   duplicate.](/de/doc/issue-tracking/#new-issues-should-not-be-duplicates-of-existing-issues)
...
closed](/de/doc/issue-tracking/#how-issues-get-closed) for details about when,
...
lists (see [Help, Support, Mailing Lists, and Forum](/de/support/)). You can
...
Support, Mailing Lists, and Forum](/de/support/) for appropriate place to ask
...
Forum](/de/support/) for the appropriate place to post it. If your issue would be
...
information out of dom0](/de/doc/how-to-copy-from-dom0/)). If your issue is
...
List (HCL) report](/de/doc/hcl/#generating-and-submitting-new-reports), then
...
[testing](/de/doc/testing/) repository, please reference the appropriate issue in
...
appropriate [testing](/de/doc/testing/) repository, then to the appropriate stable
repository. If you so choose, you can test the fix while it's in the
[testing](/de/doc/testing/) repository, or you can wait for it to land in the
