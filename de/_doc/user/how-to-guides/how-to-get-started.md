...
lang: de
layout: doc
permalink: /de/doc/how-to-get-started/
redirect_from:
...
After [downloading](/de/downloads/) and [installing](/de/doc/installation-guide/)
...
called [qubes](/de/doc/glossary/#qube). For example, you might have a work qube, a
...
qube](/de/doc/glossary/#app-qube), which is a qube intended for running software
programs like web browsers, email clients, and word processors. Each app qube
is based on another type of qube called a [template](/de/doc/glossary/#template).
...
qube](/de/doc/glossary/#service-qube). If you need to access USB devices, another
service qube will do that. There's also a [management
qube](/de/doc/glossary/#management-qube) that automatically handles a lot of
...
qube](/de/doc/glossary/#admin-qube) which, as the name suggests, is used to
administer your entire system. There's only one admin qube, and it's called
[dom0](/de/doc/glossary/#dom0). You can think of it as the master qube, holding
...
default desktop environment, but it also supports [KDE](/de/doc/kde/), as well as
the window managers [i3](/de/doc/i3/) and [AwesomeWM](/de/doc/awesomewm/).
...
can be found [here](/de/doc/tools/).
...
<a id="adding-removing-and-listing-qubes"></a>
...
<a id="how-many-qubes-do-i-need"></a>
...
## Secure Habits
<a id="secure-habits"></a>

It is *very important* to [keep Qubes updated](/de/doc/how-to-update/) to ensure
...
system](/de/doc/how-to-back-up-restore-and-migrate/) allows you to do this
securely and easily.
...
[How-to Guides](/de/doc/#how-to-guides) section in the docs.

- [How to Update](/de/doc/how-to-update/)
- [How to Back Up, Restore, and Migrate](/de/doc/how-to-back-up-restore-and-migrate/)
- [How to Copy and Paste Text](/de/doc/how-to-copy-and-paste-text/)
- [How to Copy and Move Files](/de/doc/how-to-copy-and-move-files/)
- [How to Copy from Dom0](/de/doc/how-to-copy-from-dom0/)
- [How to Install Software](/de/doc/how-to-install-software/)
- [How to Use Devices (block storage, USB, and PCI devices)](/de/doc/how-to-use-devices/)

If you encounter any problems, please visit the [Help, Support, Mailing Lists,
and Forum](/de/support/) page.

## Compatible Hardware
<a id="compatible-hardware"></a>

Make sure your hardware satisfies the [system
requirements](/de/doc/system-requirements/), as Qubes OS cannot run on every type
of computer. You may also want to check out [Qubes-certified
Hardware](/de/doc/certified-hardware/) and take a look at the [Hardware
Compatibility List (HCL)](/de/hcl/).

## Downloads
<a id="downloads"></a>

[Download an ISO](/de/downloads/), learn how to [verify its
authenticity](/de/doc/verifying-signatures/), and follow our [guide to install
Qubes OS](/de/doc/installation-guide/). Looking for the [source
code](/de/doc/source-code/)? You'll find it [on
GitHub](https://github.com/QubesOS).

## Documentation
<a id="documentation"></a>

Peruse our extensive library of [documentation](/de/doc/) for users and developers
of Qubes OS. You can even [help us improve it](/de/doc/doc-guidelines/)!