...
lang: de
layout: doc
permalink: /de/doc/how-to-use-usb-devices/
redirect_from:
- /de/doc/usb-devices/
- /de/doc/usb/
ref: 195
...
*This page is part of [device handling in qubes](/de/doc/how-to-use-devices/).*

If you are looking to handle USB *storage* devices (thumbdrives or USB-drives), please have a look at the [block device](/de/doc/how-to-use-block-storage-devices/) page.

**Note:** Attaching USB devices to VMs requires a [USB qube](/de/doc/usb-qubes/).

**Important security warning:** USB passthrough comes with many security implications.
Please make sure you carefully read and understand the **[security considerations](/de/doc/device-handling-security/#usb-security)**.
Whenever possible, attach a [block device](/de/doc/how-to-use-block-storage-devices/) instead.
...
- [optical drives](/de/doc/recording-optical-discs/) for recording

(If you are thinking to use a two-factor-authentication device, [there is an app for that](/de/doc/u2f-proxy/).
...
If you've later decided to create a usb-qube, please follow [this guide](/de/doc/usb-qubes/).
...
**Warning:** especially keyboards need to be accepted by default when using them to login! Please make sure you carefully read and understood the **[security considerations](/de/doc/device-handling-security/#usb-security)** before continuing!

Mouse and keyboard setup are part of [setting up a USB-qube](/de/doc/usb-qubes/#enable-a-usb-keyboard-for-login).
...
Now you see the path and the text between `/pci0000:00/0000:` and `/usb3` i.e. `00:1a.0` is the BDF address. Strip the address and pass it to the [`qvm-pci` tool](/de/doc/how-to-use-pci-devices/) to attach the controller to the targetVM.
