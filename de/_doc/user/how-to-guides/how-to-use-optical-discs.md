...
lang: de
layout: doc
permalink: /de/doc/how-to-use-optical-discs/
redirect_from:
- /de/doc/optical-discs/
...
To access an optical disc via USB follow the [typical procedure for attaching a USB device](/de/doc/how-to-use-usb-devices/#with-the-command-line-tool), then check with the **Qubes Devices** widget to see what device in the target qube the USB optical drive was attached to.
