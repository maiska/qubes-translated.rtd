...
lang: de
layout: doc
permalink: /de/doc/how-to-copy-and-paste-text/
redirect_from:
- /de/doc/CopyPaste/
- /de/doc/copy-paste/
- /de/wiki/CopyPaste/
...
If you wish to copy more complex data, such as rich text or images, see [copying and moving files between qubes](/de/doc/how-to-copy-and-move-files/).
For dom0, see [copying from (and to) dom0](/de/doc/how-to-copy-from-dom0/).*
...
The Qubes clipboard [RPC policy](/de/doc/rpc-policy/) is configurable in:
