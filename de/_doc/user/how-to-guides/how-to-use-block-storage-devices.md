...
lang: de
layout: doc
permalink: /de/doc/how-to-use-block-storage-devices/
redirect_from:
- /de/doc/StickMounting/
- /de/doc/block-devices/
...
Entries starting with a number (e.g. here `2-1`) are the [whole usb-device](/de/doc/how-to-use-usb-devices/).
