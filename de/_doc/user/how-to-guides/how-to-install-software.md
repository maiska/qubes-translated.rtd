...
lang: de
layout: doc
permalink: /de/doc/how-to-install-software/
redirect_from:
- /de/doc/SoftwareUpdateVM/
- /de/doc/software-update-domu/
...
in a [template](/de/doc/glossary/#template).

Advanced users may also be interested in learning how to install software in
[standalones](/de/doc/standalones-and-hvms/) and
...
6. (Recommended) In the relevant qubes' **Qube Settings**, go to the
   **Applications** tab, select the new application(s) from the list, and press
   ...
   encounter problems, see [here](/de/doc/app-menu-shortcut-troubleshooting/) for
   troubleshooting.)
...
- If your software requires special files or directories to be persistent, and
  ...
  HVMs](/de/doc/standalones-and-hvms/) and [How to Make Any File Persistent
  (bind-dirs)](/de/doc/bind-dirs/).
- [Ask for help.](/de/support/)
...
[standalones](/de/doc/glossary/#standalone) is the same as described above for
...
framework](/de/doc/qubes-service/)):
