...
lang: de
layout: doc
permalink: /de/doc/how-to-use-devices/
redirect_from:
- /de/doc/ExternalDeviceMountPoint/
- /de/doc/device-handling/
...
For specific devices ([block](/de/doc/how-to-use-block-storage-devices/), [USB](/de/doc/how-to-use-usb-devices/) and [PCI](/de/doc/how-to-use-pci-devices/) devices), please visit their respective pages.

**Important security warning:** Device handling comes with many security implications.
Please make sure you carefully read and understand the **[security considerations](/de/doc/device-handling-security/)**.
