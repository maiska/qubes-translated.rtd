...
lang: de
layout: doc
permalink: /de/doc/how-to-copy-from-dom0/
redirect_from:
- /de/doc/CopyToDomZero/
- /de/doc/copy-from-dom0/
- /de/doc/copy-to-dom0/
...
This page covers copying files and clipboard text between [dom0](/de/doc/glossary/#dom0) and [domUs](/de/doc/glossary/#domu).
Since dom0 is special, the processes are different from [copying and pasting text between qubes](/de/doc/how-to-copy-and-paste-text/) and [copying and moving files between qubes](/de/doc/how-to-copy-and-move-files/).
...
A safer approach is simply to display the image in [full-screen mode](/de/doc/full-screen-mode/) in an app qube, then take a screenshot from dom0, which results in exactly the image needed for a wallpaper, created securely and natively in dom0.
