...
lang: de
layout: doc
permalink: /de/doc/how-to-use-disposables/
redirect_from:
- /de/doc/DisposableVms/
- /de/doc/disposable/
- /de/doc/disposablevm/
- /de/doc/dispvm/
- /de/doc/how-to-use-disposablevms/
- /de/wiki/DisposableVMs/
ref: 203
title: How to Use Disposables
---

A [disposable](/de/doc/glossary/#disposable) is a lightweight [qube](/de/doc/glossary/#qube) that can be created quickly and will self-destruct when closed.
...
If a [disposable template](/de/doc/glossary/#disposable-template) becomes compromised, then any disposable based on that disposable template could be compromised.
...
Similarly to how app qubes are based on their underlying [template](/de/doc/glossary/#template), disposables are based on their underlying [disposable template](/de/doc/glossary/#disposable-template).
...
More information about RPC policies for disposables can be found [here](/de/doc/qrexec/#qubes-rpc-administration).
...
Full instructions can be found [here](/de/doc/disposable-customization/).