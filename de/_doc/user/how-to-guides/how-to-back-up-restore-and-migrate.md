...
lang: de
layout: doc
permalink: /de/doc/how-to-back-up-restore-and-migrate/
redirect_from:
- /de/doc/BackupRestore/
- /de/doc/backup-restore/
...
3. Select the destination for the backup:
   ...
   backup to a [USB mass storage device](/de/doc/usb/), you can use the directory
...
2. Select the source location of the backup to be restored:
   ...
   - If your backup is located on a [USB mass storage device](/de/doc/usb/),
...
Qubes](/de/downloads/) on the new machine, and follow the restoration procedure on
