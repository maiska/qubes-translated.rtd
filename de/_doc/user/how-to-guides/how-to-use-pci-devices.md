...
lang: de
layout: doc
permalink: /de/doc/how-to-use-pci-devices/
redirect_from:
...
Please make sure you carefully read and understand the **[security considerations](/de/doc/device-handling-security/#pci-security)** before deviating from default behavior.

## Introduction
<a id="introduction"></a>

Unlike other devices ([USB](/de/doc/how-to-use-usb-devices/), [block](/de/doc/how-to-use-block-storage-devices/), mic), PCI devices need to be attached on VM-bootup.
...
This requirement can be dropped with the `no-strict-reset` option during attachment, bearing in mind the aforementioned [security considerations](/de/doc/device-handling-security/#pci-security).
...
It's a shortcut for [`qvm-device pci`](/de/doc/how-to-use-devices/#general-qubes-device-widget-behavior-and-handling).
...
Visit the [PCI Troubleshooting guide](/de/doc/pci-troubleshooting/) to see issues that may arise due to PCI devices and how to troubleshoot them.
...
Both are intended to fix device or driver specific issues, but both come with [heavy security implications](/de/doc/device-handling-security/#pci-security)! **Make sure you understand them before continuing!**
