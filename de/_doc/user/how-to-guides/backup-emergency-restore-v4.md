...
on any GNU/Linux system.
 ...
 1. If you're not on Qubes 4.X, [get and verify the Release 4 Signing Key](/de/security/verifying-signatures/#2-get-the-release-signing-key).
...
*compressed*.
 ...
 3. Verify the integrity of `backup-header`. For compatibility reasons,
    ...
    **Note:** If this command fails, it may be that the backup was tampered
    ...
    - [Emergency Backup Recovery without Qubes (v2)](/de/doc/backup-emergency-restore-v2/)
    - [Emergency Backup Recovery without Qubes (v3)](/de/doc/backup-emergency-restore-v3/)
