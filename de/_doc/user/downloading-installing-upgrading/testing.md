...
which you can [contribute](/de/doc/contributing/) to the Qubes OS Project. There
...
* Use [qubes-builder](/de/doc/qubes-builder/) to build the latest release.
...
Please make sure to [report any bugs you encounter](/de/doc/issue-tracking/).

See [Version Scheme](/de/doc/version-scheme/) for details about release versions
and schedules. See [Release Checklist](/de/doc/releases/todo/) for details about
the RC process.
...
* Enable [dom0 testing
  repositories](/de/doc/how-to-install-software-in-dom0/#testing-repositories).
* Enable [template testing
  repositories](/de/doc/how-to-install-software/#testing-repositories).
...
bug](/de/doc/issue-tracking/) in a package that is in a testing repository, please
