...
or minor release (see [Version Scheme](/de/doc/version-scheme/)). The current
release and past major releases are always available on the
[Downloads](/de/downloads/) page, while all ISOs, including past minor releases,
are available from our [download mirrors](/de/downloads/#mirrors).
...
[security-critical](/de/doc/security-critical-code/), and we provide updates for
...
The following table shows select [template](/de/doc/templates/) versions that are
currently supported. Currently, only [Fedora](/de/doc/templates/fedora/) and
[Debian](/de/doc/templates/debian/) templates are officially supported by the
Qubes OS Project. [Whonix](/de/doc/whonix/) templates are supported by our
...
a mailing list similar to [qubes-announce](/de/support/#qubes-announce), which
...
[Whonix](/de/doc/whonix/) templates are supported by our partner, the [Whonix
