...
<div class="alert alert-danger" role="alert">
  ...
  Regardless of how you acquire your Qubes ISO, <a href="/de/security/verifying-signatures/">verify its authenticity</a> before continuing.
</div>
...
<div class="alert alert-warning" role="alert">
  <i class="fa fa-exclamation-circle"></i>
  <b>Note:</b> There are important <a href="/de/doc/install-security/">security considerations</a> to keep in mind when choosing an installation medium.
</div>
...
The Qubes OS Project occasionally issues [Qubes Security Bulletins (QSBs)](/de/security/bulletins/) as part of the [Qubes Security Pack (qubes-secpack)](/de/security/pack/).
...
For this reason, we strongly recommend that every Qubes user subscribe to the [qubes-announce](/de/support/#qubes-announce) mailing list.

In addition to QSBs, the Qubes OS Project also publishes [Canaries](/de/security/canaries/), XSA summaries, TemplateVM releases and end-of-life notices, and other items of interest to Qubes users.
Since these are not essential for all Qubes users to read, they are not sent to [qubes-announce](/de/support/#qubes-announce) in order to keep the volume on that list low.
However, we expect that most users, especially novice users, will find them helpful.
If you are interested in these additional items, we encourage you to subscribe to the [Qubes News RSS feed](/feed.xml) or join one of our other [venues](/de/support/), where these news items are also announced.

For more information about Qubes OS Project security, please see the [security center](/de/security/).
...
[Help, Support, Mailing Lists, and Forum]: /de/support/
[update]: /de/doc/updating-qubes-os/
[Qubes backup system]: /de/doc/backup-restore/
[Common Tasks]: /de/doc/#common-tasks
[Managing Operating Systems within Qubes]: /de/doc/#managing-operating-systems-within-qubes
[installation security]: /de/doc/install-security/
...
[advanced configuration]: /de/doc/#advanced-configuration
[hcl-howto]: /de/doc/hcl/#generating-and-submitting-new-reports
[Get Started]: /de/getting-started/