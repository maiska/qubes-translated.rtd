...
<div class="alert alert-danger" role="alert">
  ...
  See <a href="/de/doc/install-security/">installation security</a> for more information.
</div>

Qubes OS has very specific [system requirements](/de/doc/system-requirements/). To
ensure compatibility, we strongly recommend using [Qubes-certified
hardware](/de/doc/certified-hardware/). Other hardware may require you to perform
...
Start by [downloading](/de/downloads/) a Qubes ISO.
...
<div class="alert alert-danger" role="alert">
  ...
  href="/de/security/verifying-signatures/">verify its authenticity</a> before
  continuing.
</div>
...
[downloads](/de/downloads/) page by hovering over the download button.

<div class="alert alert-warning" role="alert">
  <i class="fa fa-exclamation-circle"></i>
  <b>Note:</b> There are important <a href="/de/doc/install-security/">security
...
please see [custom installation](/de/doc/custom-install/). Otherwise, follow the
instructions below.
...
* **Debian:** Select this option if you would like to use
  [Debian](/de/doc/templates/debian/) qubes in addition to the default Fedora
  qubes.
* **Whonix:** Select this option if you would like to use
  [Whonix](/de/doc/whonix/) qubes. Whonix allows you to use
...
these and other [templates](/de/doc/templates/) later. If you're short on disk
...
[Advanced Topics](/de/doc/#advanced-topics)).
...
Next, [update](/de/doc/how-to-update/) your installation to ensure you have
...
(QSBs)](/de/security/qsb/) as part of the [Qubes Security Pack
(qubes-secpack)](/de/security/pack/). It is important to make sure that you
...
[qubes-announce](/de/support/#qubes-announce) mailing list.

In addition to QSBs, the Qubes OS Project also publishes
[Canaries](/de/security/canary/), XSA summaries, template releases and
...
[qubes-announce](/de/support/#qubes-announce) in order to keep the volume on that
...
of our other [venues](/de/support/), where these news items are also announced.
...
report](/de/doc/hcl/#generating-and-submitting-new-reports).

### Get Started
<a id="get-started"></a>

Find out [How to Get Started](/de/doc/how-to-get-started/) with Qubes, check out
the other [How-to Guides](/de/doc/#how-to-guides), and learn about
[Templates](/de/doc/#templates).

## Getting help
<a id="getting-help"></a>

* We work very hard to make the [documentation](/de/doc/) accurate, comprehensive
  ...
  [improving](/de/doc/doc-guidelines/) it!)
...
* If you don't find your answer in the documentation, please see [Help,
  Support, Mailing Lists, and Forum](/de/support/) for places to ask.
...
* Please do **not** email individual members of the Qubes team with questions
  ...
  Mailing Lists, and Forum](/de/support/) for appropriate places to ask questions.