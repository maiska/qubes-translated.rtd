...
This page provides instructions for performing an in-place upgrade of an installed [Debian Template](/de/doc/templates/debian/).
If you wish to install a new, unmodified Debian template instead of upgrading a template that is already installed in your system, please see the [Debian Template](/de/doc/templates/debian/) page instead. ([Learn more about the two options.](/de/doc/templates/debian/#upgrading))
...
9. (Recommended) [Switch everything that was set to the old template to the new template.](/de/doc/templates/#switching)
...
11. (Optional) [Uninstall the old template.](/de/doc/templates/#uninstalling)
    Make sure that the template you're uninstalling is the old one, not the new one!

## Standalones
<a id="standalones"></a>

The procedure for upgrading a Debian [standalone](/de/doc/standalone-and-hvm/) is the same as for a template.
