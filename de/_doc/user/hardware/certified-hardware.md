...
See [Hardware Testing](/de/doc/hardware-testing/) for details.

## Qubes-certified Laptops
<a id="qubes-certified-laptops"></a>

Qubes-certified laptops are certified for a [major version](/de/doc/version-scheme/) and regularly tested by the Qubes developers to ensure compatibility with all of Qubes' features within that major version.
...
For the latter, please see the [system requirements](/de/doc/system-requirements/).)
...
This could be done by consulting the [Hardware Compatibility List](/de/hcl/) or trying to install it themselves before shipping any units to us.
