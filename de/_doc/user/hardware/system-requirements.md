...
<div class="alert alert-warning" role="alert">
  ...
  recommend consulting the <a href="/de/hcl/">Hardware Compatibility List</a> to
...
- **Graphics:** Intel integrated graphics processor (IGP) strongly recommended
  - Nvidia GPUs may require significant
    [troubleshooting](/de/doc/install-nvidia-driver/)
...
- Please see the [Hardware Compatibility List](/de/hcl/) for a compilation of
  hardware reports generated and submitted by users across various Qubes
  versions. (For more information about the HCL itself, see [here](/de/doc/hcl/).)
- See the [Certified Hardware](/de/doc/certified-hardware/) page.
- See the [Hardware Testing](/de/doc/hardware-testing/) page.
...
- Qubes **can** be installed on a USB flash drive or external disk, and testing
  ...
  [hcl-report](/de/doc/hcl/#generating-and-submitting-new-reports) for advice on
