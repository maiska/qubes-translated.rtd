...
A [DisposableVM](/doc/disposablevm) can be based on any [TemplateBasedVM](/de/doc/glossary/#templatebasedvm).
You can also choose to use different [DisposableVM Templates](/de/doc/glossary/#disposablevm-template) for different DisposableVMs.
