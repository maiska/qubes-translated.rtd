...
======================================
<a id="copying-and-pasting-text-between-qubes"></a>

*This page is about copying and pasting plain text.
If you wish to copy more complex data, such as rich text or images, see [copying and moving files between qubes](/de/doc/copying-files/).
For dom0, see [copying from (and to) dom0](/de/doc/copy-from-dom0/).*
