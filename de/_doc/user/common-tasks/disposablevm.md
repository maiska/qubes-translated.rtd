...
Similarly to how AppVMs are based on their underlying [TemplateVM](/de/doc/glossary/#templatevm), DisposableVMs are based on their underlying [DisposableVM Template](/de/doc/glossary/#disposablevm-template).
