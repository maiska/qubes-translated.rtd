...
lang: de
layout: doc
permalink: /de/doc/installation-troubleshooting/
ref: 224
...
If you are facing issues when booting using UEFI mode, see the [UEFI troubleshooting guide](/de/doc/uefi-troubleshooting/). 
...
Ensure that the installer is correct and complete before writing it to a flash drive by [verifying the ISO](/de/security/verifying-signatures/#how-to-verify-qubes-iso-signatures). 
* **Change the method you used to [write your ISO to a USB key](/de/doc/installation-guide/#copying-the-iso-onto-the-installation-medium):** 
...
Visit the [UEFI Troubleshooting guide](/de/doc/uefi-troubleshooting/) if other errors arise during UEFI booting. 
