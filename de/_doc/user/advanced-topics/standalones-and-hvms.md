...
lang: de
layout: doc
permalink: /de/doc/standalones-and-hvms/
redirect_from:
- /de/doc/HvmCreate/
- /de/doc/hvm-create/
- /de/doc/hvm/
- /de/doc/standalone-and-hvm/
- /de/doc/standalones-and-hvm/
- /de/wiki/HvmCreate/
ref: 130
title: Standalones and HVMs
---

A [standalone](/de/doc/glossary/#standalone) is a type of qube that is created by
cloning a [template](/de/doc/glossary/#template). Unlike templates, however,
...
Meanwhile, a [Hardware-assisted Virtual Machine (HVM)](/de/doc/glossary/#hvm),
...
independent qube. See [How to Update](/de/doc/how-to-update/).
...
Qubes are template-based (i.e., [app qubes](/de/doc/glossary/#app-qube) by
...
[keys](/de/doc/vm-interface/#qubesdb) exposed by dom0 to the qube). Such
...
[netvm](/de/doc/glossary/#netvm).) In this instance, our DHCP server is not
useful.
...
support](/de/doc/networking/#ipv6) for IPv6 forwarding.
...
devices](/de/doc/how-to-use-pci-devices/) just like normal app qubes. For example,
