...
lang: de
layout: doc
permalink: /de/doc/managing-vm-kernels/
redirect_from:
- /de/doc/managing-vm-kernel/
ref: 173
title: Managing VM Kernels
---

By default, VMs kernels are provided by dom0.
(See [here](/de/doc/how-to-install-software-in-dom0/#kernel-upgrade) for information about upgrading kernels in dom0.)
This means that:
...
In case of problems, visit the [VM Troubleshooting guide](/de/doc/vm-troubleshooting/#vm-kernel-troubleshooting) to learn how to access the VM console, view logs and fix a VM kernel installation.