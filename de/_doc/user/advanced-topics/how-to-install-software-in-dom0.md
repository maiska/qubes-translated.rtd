...
lang: de
layout: doc
permalink: /de/doc/how-to-install-software-in-dom0/
redirect_from:
- /de/doc/SoftwareUpdateDom0/
- /de/doc/software-update-dom0/
...
There are three Qubes dom0 [testing](/de/doc/testing/) repositories:
...
packages](/de/doc/installing-contributed-packages/).
...
- `kernel`: an older LTS kernel that has passed Qubes [testing](/de/doc/testing/)
  (the default dom0 kernel)
- `kernel-latest`: the latest release from kernel.org that has passed Qubes
  [testing](/de/doc/testing/) (useful for [troubleshooting newer
  hardware](/de/doc/newer-hardware-troubleshooting/))
...
[Managing VM kernel](/de/doc/managing-vm-kernels/) for more information.
