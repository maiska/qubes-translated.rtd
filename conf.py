...
execfile_(os.path.join(BASEDIR, '_doc/docs/source/conf.py'), globals())

locale_dirs = [os.path.join(BASEDIR, 'locale/')]
gettext_compact = False

setup_original = setup  # from '_doc/docs/source/conf.py'

def setup(app):
    app.srcdir = os.path.join(BASEDIR, '_doc/docs/source')
